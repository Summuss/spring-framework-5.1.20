...
public interface Expression {
     ...
     */
    @Nullable
    <T> T getValue(Object rootObject, @Nullable Class<T> desiredResultType)
    ...
    @Nullable
    <T> T getValue(
            EvaluationContext context, Object rootObject, @Nullable Class<T> desiredResultType)
            throws EvaluationException;
     ...
     * @throws EvaluationException if there is a problem during evaluation
     */
    void setValue(EvaluationContext context, Object rootObject, @Nullable Object value)
            throws EvaluationException;
}
