...
public class SpelExpression implements Expression {
    ...
    @Override
    @Nullable
    public <T> T getValue(Object rootObject, @Nullable Class<T> expectedResultType)
    ...
    @Nullable
    public <T> T getValue(
            EvaluationContext context, Object rootObject, @Nullable Class<T> expectedResultType)
            throws EvaluationException {
