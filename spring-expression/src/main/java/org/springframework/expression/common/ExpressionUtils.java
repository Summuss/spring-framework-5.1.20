...
public abstract class ExpressionUtils {
    ...
    /**
     * Determines if there is a type converter available in the specified context and attempts to
     * use it to convert the supplied value to the specified type. Throws an exception if conversion
     * is not possible.
     *
     ...
     * @throws EvaluationException if there is a problem during conversion or conversion of the
     *     value to the specified type is not supported
     */
