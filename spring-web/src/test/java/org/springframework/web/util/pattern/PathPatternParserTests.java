...
public class PathPatternParserTests {
    ...
    public void regexPathElementPatterns() {
        ...
        pathPattern = checkStructure("*");
        assertEquals(
                WildcardPathElement.class.getName(),
                pathPattern.getHeadSection().getClass().getName());
        checkStructure("/*");
        checkStructure("/*/");
        checkStructure("*/");
        checkStructure("/*/");
        ...
        assertEquals(
                RegexPathElement.class.getName(),
                pathPattern.getHeadSection().getClass().getName());
    }
    ...
    public void completeCapturingPatterns() {
        ...
        assertEquals(
                CaptureVariablePathElement.class.getName(),
                pathPattern.getHeadSection().getClass().getName());
        checkStructure("/{foo}");
        checkStructure("/{f}/");
    ...
    public void illegalCapturePatterns() {
        ...
        try {
            ...
            assertEquals(
                    "No capture groups allowed in the constraint regex: foo(bar)",
                    iae.getMessage());
        }
        try {
    ...
    public void patternPropertyGetWildcardCountTests() {
        ...
        assertEquals(
                computeScore(4, 3), parse("/{foo}/*/*_*/{bar}_{goo}_{wibble}/abc/bar").getScore());
    }
    ...
    private final void assertPathElements(
        ...
        for (Class<? extends PathElement> sectionClass : sectionClasses) {
            ...
            assertEquals(
                    "Not expected section type. Pattern is: " + p.toChainString(),
                    sectionClass.getSimpleName(),
