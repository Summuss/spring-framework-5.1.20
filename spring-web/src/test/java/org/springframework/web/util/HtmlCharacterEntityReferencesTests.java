    ...
    public void testSupportsAllCharacterEntityReferencesDefinedByHtml() {
        ...
        for (int character = 0; character < 10000; character++) {
            ...
            if (referenceName != null) {
                ...
                assertTrue(
                        "The unicode character " + character + " should be mapped to a reference",
                ...
                assertEquals(
                        "The entity reference ["
                                ...
                                + character,
                        (char) character,
                        entityReferences.convertToCharacter(referenceName));
                ...
                assertFalse(
                        ...
                        entityReferences.isMappedToReference((char) character));
                assertNull(
                        "No entity reference of unicode character " + character + " should exist",
                        entityReferences.convertToReference((char) character));
            }
        }
        ...
        assertEquals(
                "Invalid entity reference names should not be convertible",
                (char) -1,
