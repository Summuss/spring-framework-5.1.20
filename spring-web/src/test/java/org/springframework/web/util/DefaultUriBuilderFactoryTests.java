...
public class DefaultUriBuilderFactoryTests {
    ...
    public void baseUri() {
        DefaultUriBuilderFactory factory =
                new DefaultUriBuilderFactory("http://example.com/v1?id=123");
    ...
    public void baseUriWithFullOverride() {
        ...
        assertEquals(
                "Use of host should case baseUri to be completely ignored",
    ...
    public void defaultUriVarsWithEmptyVarArg() {
        ...
        assertEquals(
                "Expected delegation to build(Map) method",
                "http://example.com/v1/bar",
                uri.toString());
    }
    ...
    public void encodingValuesOnlySpr14147() {
        ...
        assertEquals(
                "http://example.com/user/john%3Bdoe/dashboard",
