...
public class DefaultCorsProcessorTests {
    ...
    public void actualRequestWithOriginHeader() throws Exception {
        ...
        assertThat(
                this.response.getHeaders(HttpHeaders.VARY),
                contains(
                        HttpHeaders.ORIGIN,
    ...
    public void actualRequestCredentials() throws Exception {
        ...
        assertEquals(
                "https://domain2.com",
                this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN));
    ...
    public void preflightRequestAllowsAllHeaders() throws Exception {
        ...
        assertTrue(
                this.response
                        ...
                        .contains("Header2"));
        assertFalse(
                this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS).contains("*"));
        assertThat(
                this.response.getHeaders(HttpHeaders.VARY),
                contains(
                        HttpHeaders.ORIGIN,
