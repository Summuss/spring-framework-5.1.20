...
public class CorsConfigurationTests {
    ...
    public void combineWithDefaultPermitValues() {
        ...
        assertEquals(
                ...
                combinedConfig.getAllowedMethods());
        assertEquals(Collections.emptyList(), combinedConfig.getExposedHeaders());
    ...
    public void combineWithDuplicatedElements() {
        ...
        CorsConfiguration combinedConfig = config.combine(other);
        assertEquals(
                Arrays.asList("https://domain1.com", "https://domain2.com"),
                combinedConfig.getAllowedOrigins());
        ...
        assertEquals(
                Arrays.asList(HttpMethod.GET.name(), HttpMethod.PUT.name()),
                combinedConfig.getAllowedMethods());
    }
    ...
    public void checkMethodAllowed() {
        ...
        assertEquals(
                ...
                config.checkHttpMethod(HttpMethod.GET));
        ...
        assertEquals(
                Arrays.asList(HttpMethod.GET, HttpMethod.POST),
                config.checkHttpMethod(HttpMethod.POST));
    }
