...
public class CookieValueMethodArgumentResolverTests {
    ...
    public void supportsParameter() {
        ...
        assertTrue(
                "Cookie string parameter not supported",
                resolver.supportsParameter(paramNamedDefaultValueString));
        assertFalse(
                "non-@CookieValue parameter supported", resolver.supportsParameter(paramString));
    }
