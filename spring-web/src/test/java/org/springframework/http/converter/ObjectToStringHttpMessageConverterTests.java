...
public class ObjectToStringHttpMessageConverterTests {
    ...
    public void read() throws IOException {
        ...
        assertEquals(
                shortValue,
                this.converter.read(Short.class, new ServletServerHttpRequest(request)));
        ...
        assertEquals(
                floatValue,
                this.converter.read(Float.class, new ServletServerHttpRequest(request)));
        ...
        assertEquals(
                longValue, this.converter.read(Long.class, new ServletServerHttpRequest(request)));
    }
    ...
    public void writeUtf16() throws IOException {
        ...
        assertArrayEquals(
                new byte[] {-2, -1, 0, '9', 0, '5', 0, '8'},
                this.servletResponse.getContentAsByteArray());
    }
