...
public class ResourceRegionHttpMessageConverterTests {
    ...
    public void canWriteResource() {
        assertTrue(
                converter.canWrite(ResourceRegion.class, null, MediaType.APPLICATION_OCTET_STREAM));
    ...
    public void canWriteResourceCollection() {
        ...
        assertTrue(
                converter.canWrite(resourceRegionList, null, MediaType.APPLICATION_OCTET_STREAM));
    ...
    public void shouldWritePartialContentByteRangeNoEnd() throws Exception {
        ...
        assertThat(
                ...
                is("Framework test resource content."));
    }
    ...
    public void partialContentMultipleByteRanges() throws Exception {
        ...
        assertThat(
                ...
                Matchers.startsWith("multipart/byteranges;boundary="));
    ...
    public void applicationOctetStreamDefaultContentType() throws Exception {
        ...
        assertThat(
                outputMessage.getHeaders().getFirst(HttpHeaders.CONTENT_RANGE), is("bytes 0-5/12"));
        assertThat(outputMessage.getBodyAsString(StandardCharsets.UTF_8), is("Spring"));
    }
}
