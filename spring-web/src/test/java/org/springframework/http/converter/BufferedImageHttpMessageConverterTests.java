...
public class BufferedImageHttpMessageConverterTests {
    ...
    public void canRead() {
        ...
        assertTrue(
                "Image not supported",
                converter.canRead(BufferedImage.class, new MediaType("image", "png")));
    }
    ...
    public void canWrite() {
        ...
        assertTrue(
                "Image not supported",
                converter.canWrite(BufferedImage.class, new MediaType("image", "png")));
        assertTrue(
                "Image not supported",
                converter.canWrite(BufferedImage.class, new MediaType("*", "*")));
    }
    ...
    public void write() throws IOException {
        ...
        assertEquals(
                ...
                contentType,
                outputMessage.getWrittenHeaders().getContentType());
