...
public class CodecConfigurerTests {
    ...
    public void defaultReaders() {
        ...
        assertEquals(
                FormHttpMessageReader.class, readers.get(this.index.getAndIncrement()).getClass());
    ...
    public void defaultWriters() {
        ...
        assertEquals(
                ResourceHttpMessageWriter.class, writers.get(index.getAndIncrement()).getClass());
        assertStringEncoder(getNextEncoder(writers), true);
        assertEquals(
                ProtobufHttpMessageWriter.class, writers.get(index.getAndIncrement()).getClass());
    ...
    public void defaultAndCustomReaders() {
        ...
        when(customDecoder1.canDecode(ResolvableType.forClass(Object.class), null))
                .thenReturn(false);
        when(customDecoder2.canDecode(ResolvableType.forClass(Object.class), null))
                .thenReturn(true);
    ...
    public void defaultAndCustomWriters() {
        ...
        when(customEncoder1.canEncode(ResolvableType.forClass(Object.class), null))
                .thenReturn(false);
        when(customEncoder2.canEncode(ResolvableType.forClass(Object.class), null))
                .thenReturn(true);
    ...
    public void cloneDefaultCodecs() {
        ...
        assertFalse(
                decoders.containsAll(Arrays.asList(jacksonDecoder, jaxb2Decoder, protoDecoder)));
        assertFalse(
                encoders.containsAll(Arrays.asList(jacksonEncoder, jaxb2Encoder, protoEncoder)));
    }
    ...
    private void assertStringDecoder(Decoder<?> decoder, boolean textOnly) {
        ...
        assertTrue(
                decoder.canDecode(ResolvableType.forClass(String.class), MimeTypeUtils.TEXT_PLAIN));
        assertEquals(
                !textOnly,
                decoder.canDecode(
    ...
    private void assertStringEncoder(Encoder<?> encoder, boolean textOnly) {
        ...
        assertTrue(
                encoder.canEncode(ResolvableType.forClass(String.class), MimeTypeUtils.TEXT_PLAIN));
        assertEquals(
                !textOnly,
                encoder.canEncode(
                        ResolvableType.forClass(String.class), MediaType.TEXT_EVENT_STREAM));
