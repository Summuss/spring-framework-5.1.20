...
public class ServerCodecConfigurerTests {
    ...
    public void defaultReaders() {
        ...
        assertEquals(
                SynchronossPartHttpMessageReader.class,
                readers.get(this.index.getAndIncrement()).getClass());
        assertEquals(
                MultipartHttpMessageReader.class,
                readers.get(this.index.getAndIncrement()).getClass());
    ...
    public void maxInMemorySize() {
        ...
        assertEquals(
                size,
                ((SynchronossPartHttpMessageReader) nextReader(readers)).getMaxInMemorySize());
    ...
    private void assertStringDecoder(Decoder<?> decoder, boolean textOnly) {
        ...
        assertEquals(
                !textOnly, decoder.canDecode(forClass(String.class), MediaType.TEXT_EVENT_STREAM));
    ...
    private void assertStringEncoder(Encoder<?> encoder, boolean textOnly) {
        ...
        assertEquals(
                !textOnly, encoder.canEncode(forClass(String.class), MediaType.TEXT_EVENT_STREAM));
    }
