...
public abstract class AbstractAsyncHttpRequestFactoryTestCase
        extends AbstractMockWebServerTestCase {
    ...
    protected void assertHttpMethod(String path, HttpMethod method) throws Exception {
        ...
        try {
            ...
            assertEquals(
                    "Invalid method", path.toUpperCase(Locale.ENGLISH), request.getMethod().name());
        } finally {
            if (response != null) {
                response.close();
            }
