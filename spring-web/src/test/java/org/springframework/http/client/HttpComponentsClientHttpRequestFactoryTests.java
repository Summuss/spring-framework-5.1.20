...
public class HttpComponentsClientHttpRequestFactoryTests
    ...
    public void assertCustomConfig() throws Exception {
        ...
        assertTrue(
                "Wrong request config type" + config.getClass().getName(),
        ...
        assertEquals(
                "Wrong custom connection request timeout",
                4321,
    ...
    public void defaultSettingsOfHttpClientMergedOnExecutorCustomization() throws Exception {
        ...
        assertSame(
                "Default client configuration is expected",
                defaultConfig,
                retrieveRequestConfig(hrf));
