...
public class MediaTypeTests {
    ...
    public void specificityComparator() throws Exception {
        ...
        assertEquals(
                "Invalid comparison result", 0, comp.compare(audioBasicLevel, audioBasicLevel));
        ...
        assertTrue(
                ...
                comp.compare(MediaType.APPLICATION_XHTML_XML, allXml) < 0);

        // unspecific to specific
        assertTrue("Invalid comparison result", comp.compare(audio, audioBasic) > 0);
        assertTrue(
                "Invalid comparison result",
                comp.compare(allXml, MediaType.APPLICATION_XHTML_XML) > 0);
