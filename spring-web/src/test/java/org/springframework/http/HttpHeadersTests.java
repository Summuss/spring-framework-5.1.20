...
public class HttpHeadersTests {
    ...
    public void acceptCharsets() {
        ...
        assertEquals(
                "Invalid Accept header", "utf-8, iso-8859-1", headers.getFirst("Accept-Charset"));
    }
    ...
    public void acceptCharsetWildcard() {
        ...
        assertEquals(
                ...
                Arrays.asList(StandardCharsets.ISO_8859_1, StandardCharsets.UTF_8),
    ...
    public void ifMatchMultipleHeaders() {
        ...
        assertEquals(
                "Invalid If-Match header", "\"v2,0\"", headers.get(HttpHeaders.IF_MATCH).get(0));
        assertEquals(
                "Invalid If-Match header",
                "W/\"v2,1\", \"v2,2\"",
                headers.get(HttpHeaders.IF_MATCH).get(1));
    ...
    public void ifNoneMatchList() {
        ...
        assertEquals(
                ...
                "\"v2.6\", \"v2.7\", \"v2.8\"",
                headers.getFirst("If-None-Match"));
    }
    ...
    public void contentDisposition() {
        ...
        assertEquals(
                "Invalid Content-Disposition header", disposition, headers.getContentDisposition());
    }
    ...
    public void keySetRemove() {
        ...
        assertEquals(
                Collections.singletonMap("Bravo", Arrays.asList("banana")).entrySet(),
                headers.entrySet());
    }
