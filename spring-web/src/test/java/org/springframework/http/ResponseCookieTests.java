                ...
                .forEach(
                        name -> {
                            try {
                                ...
                                assertThat(
                                        ex.getMessage(), Matchers.containsString("RFC2616 token"));
                            }
                        });
    }
                ...
                .forEach(
                        value -> {
                            try {
                                ...
                                assertThat(
                                        ex.getMessage(),
                                        Matchers.containsString("RFC2616 cookie value"));
                            }
                        });
    }
                ...
                .forEach(
                        domain -> {
                            try {
                                ...
                                assertThat(
                                        ex.getMessage(),
                                        Matchers.containsString("Invalid first/last char"));
                            }
                        });
                ...
                .forEach(
                        domain -> {
                            try {
                                ...
                                assertThat(
                                        ex.getMessage(),
                                        Matchers.containsString("invalid cookie domain char"));
                            }
                        });
    }
}
