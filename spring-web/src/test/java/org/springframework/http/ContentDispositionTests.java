...
public class ContentDispositionTests {
    ...
    public void parse() {
        assertEquals(
                builder("form-data").name("foo").filename("foo.txt").size(123L).build(),
    ...
    public void parseFilenameUnquoted() {
        assertEquals(
                builder("form-data").filename("unquoted").build(),
    ...
    public void parseFilenameWithSemicolon() {
        assertEquals(
                builder("attachment").filename("filename with ; semicolon.txt").build(),
    ...
    public void parseEncodedFilenameWithPaddedCharset() {
        assertEquals(
                builder("attachment").filename("some-file.zip", StandardCharsets.UTF_8).build(),
    ...
    public void parseEncodedFilenameWithoutCharset() {
        assertEquals(
                builder("form-data").name("name").filename("test.txt").build(),
