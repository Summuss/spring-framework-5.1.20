 ...
 * which can be provided to the {@code WebClient} through the {@code syncBody} method.
 *
 * <p>Examples:
 *
 * <pre class="code">
...
public final class MultipartBodyBuilder {
     ...
     *   <li>HttpEntity -- part content and headers although generally it's easier to add headers
    ...
    public PartBuilder part(String name, Object part, @Nullable MediaType contentType) {
        ...
        if (part instanceof PublisherEntity<?, ?>) {
            PublisherPartBuilder<?, ?> builder =
                    new PublisherPartBuilder<>((PublisherEntity<?, ?>) part);
            if (contentType != null) {
    ...
    public <T, P extends Publisher<T>> PartBuilder asyncPart(
        ...
        PublisherPartBuilder<T, P> builder =
                new PublisherPartBuilder<>(null, publisher, elementClass);
        this.parts.add(name, builder);
        return builder;
    }
    ...
    public <T, P extends Publisher<T>> PartBuilder asyncPart(
        ...
        PublisherPartBuilder<T, P> builder =
                new PublisherPartBuilder<>(null, publisher, typeReference);
        this.parts.add(name, builder);
        return builder;
    }
    ...
    private static class PublisherPartBuilder<S, P extends Publisher<S>>
        ...
        public PublisherPartBuilder(
                @Nullable HttpHeaders headers, P body, ParameterizedTypeReference<S> typeRef) {
            super(headers, body);
