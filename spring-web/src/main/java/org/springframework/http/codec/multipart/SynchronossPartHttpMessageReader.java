...
public class SynchronossPartHttpMessageReader extends LoggingCodecSupport
     ...
     * </ul>
     *
     * <p>By default in 5.1 this is set to -1 in which case this limit is not enforced and all parts
     * may be written to disk and are limited only by the {@link #setMaxDiskUsagePerPart(long)
     * maxDiskUsagePerPart} property. In 5.2 this default value for this limit is set to 256K.
     *
