...
public class Jaxb2CollectionHttpMessageConverter<T extends Collection>
     ...
     * {@inheritDoc}
     *
     * <p>Jaxb2CollectionHttpMessageConverter can read a generic {@link Collection} where the
     * generic type is a JAXB type annotated with {@link XmlRootElement} or {@link XmlType}.
     */
    @Override
    ...
    public T read(Type type, @Nullable Class<?> contextClass, HttpInputMessage inputMessage)
        ...
        try {
            ...
            throw new HttpMessageNotReadableException(
                    "Could not unmarshal to [" + elementClass + "]: " + ex.getMessage(),
                    ex,
                    inputMessage);
     ...
     *
     * <p>Can be overridden in subclasses, adding further initialization of the factory. The
