...
public class Jackson2ObjectMapperFactoryBean
     ...
     * by Spring either (see {@link #setFindModulesViaServiceLoader}). As a consequence, specifying
     * an empty list here will suppress any kind of module detection.
     *
     ...
     * META-INF metadata in the classpath. Requires Jackson 2.2 or higher.
     *
     * <p>If this mode is not set, Spring's Jackson2ObjectMapperFactoryBean itself will try to find
     * the JSR-310 and Joda-Time support modules on the classpath - provided that Java 8 and
     * Joda-Time themselves are available, respectively.
     *
     * @since 4.0.1
