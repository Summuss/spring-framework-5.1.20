 ...
 * String&gt;} and it can also write (but not read) the {@code "multipart/form-data"} media type as
 ...
 * registered (for {@code Strings} and {@code Resources}). These can be overridden through the
...
public class FormHttpMessageConverter implements HttpMessageConverter<MultiValueMap<String, ?>> {
     ...
     * multipart request.
     *
     * <p>As of 5.0 this is also used for part headers including "Content-Disposition" (and its
     * filename parameter) unless (the mutually exclusive) {@link #setMultipartCharset} is also set,
     * in which case part headers are encoded as ASCII and <i>filename</i> is encoded with the
     ...
     * "javax.mail".
     *
     * <p>As of 5.0 by default part headers, including Content-Disposition (and its filename
    ...
    private void writeMultipart(
            final MultiValueMap<String, Object> parts, HttpOutputMessage outputMessage)
            throws IOException {
    ...
    /**
     * When {@link #setMultipartCharset(Charset)} is configured (i.e. RFC 2047, "encoded-word"
