 ...
 * HttpMessageConverter} that can read and write <a href="https://cbor.io/">CBOR</a> data format
...
public class MappingJackson2CborHttpMessageConverter extends AbstractJackson2HttpMessageConverter {
     ...
     * ObjectMapper} (must be configured with a {@code CBORFactory} instance). You can use {@link
