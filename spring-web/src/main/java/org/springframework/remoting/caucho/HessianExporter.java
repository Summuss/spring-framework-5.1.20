...
public class HessianExporter extends RemoteExporter implements InitializingBean {
    ...
    /**
     * Set whether to allow non-serializable types as Hessian arguments and return values. Default
     * is "true".
     */
    ...
    /**
     * Set whether Hessian's debug mode should be enabled, logging to this exporter's Commons
     * Logging log. Default is "false".
     *
    ...
    protected void doInvoke(
        ...
        try {
            ...
            if (this.debugLogger != null && this.debugLogger.isDebugEnabled()) {
                try (PrintWriter debugWriter =
                        new PrintWriter(new CommonsLogWriter(this.debugLogger))) {
                    @SuppressWarnings("resource")
                    HessianDebugInputStream dis =
                            new HessianDebugInputStream(inputStream, debugWriter);
                    @SuppressWarnings("resource")
                    HessianDebugOutputStream dos =
                            new HessianDebugOutputStream(outputStream, debugWriter);
                    dis.startTop2();
                    dos.startTop2();
                    isToUse = dis;
                    osToUse = dos;
