...
public class SimpleHttpServerJaxWsServiceExporter extends AbstractJaxWsServiceExporter {
    ...
    /**
     * Specify an existing HTTP server to register the web service contexts with. This will
     * typically be a server managed by the general Spring {@link
     ...
     * #setHostname "hostname"} and {@link #setBacklog "backlog"} properties (or rely on the
     * defaults there).
     */
