...
public abstract class WebApplicationContextUtils {
     ...
     *
     * <p>Will rethrow an exception that happened on root context startup, to differentiate between
     * a failed context startup and no context at all.
     *
     ...
     *
     * <p>Note that {@code DispatcherServlet}'s exposure of its context can be controlled through
     * its {@code publishContext} property, which is {@code true} by default but can be selectively
     ...
     * ServletContext, ServletConfig)} that always provides {@code null} for the {@link
     ...
     *
     * <p>This method is idempotent with respect to the fact it may be called any number of times
     * but will perform replacement of stub property sources with their corresponding actual
