...
public abstract class FacesContextUtils {
     ...
     *
     * <p>In many cases, the Session reference itself is a safe mutex as well, since it will always
     * be the same object reference for the same active logical session. However, this is not
