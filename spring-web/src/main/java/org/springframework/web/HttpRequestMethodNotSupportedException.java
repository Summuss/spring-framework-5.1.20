...
public class HttpRequestMethodNotSupportedException extends ServletException {
    ...
    public HttpRequestMethodNotSupportedException(
        ...
        this(
                method,
                (supportedMethods != null ? StringUtils.toStringArray(supportedMethods) : null));
    }
    ...
    /**
     * Return the actually supported HTTP methods as {@link HttpMethod} instances, or {@code null}
     * if not known.
     *
     * @since 3.2
     */
