...
public class RequestPartServletServerHttpRequest extends ServletServerHttpRequest {
     ...
     * @param requestPartName the name of the part to adapt to the {@link ServerHttpRequest}
     *     contract
    ...
    public InputStream getBody() throws IOException {
        ...
        boolean servletParts =
                (this.multipartRequest instanceof StandardMultipartHttpServletRequest);
        if (servletParts) {
        ...
        throw new IllegalStateException(
                "No body available for request part '" + this.requestPartName + "'");
    }
    ...
    private Part retrieveServletPart() {
        try {
            ...
            throw new MultipartException(
                    "Failed to retrieve request part '" + this.requestPartName + "'", ex);
        }
    }
