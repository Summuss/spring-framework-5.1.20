...
public interface WebSessionStore {
     ...
     *
     * <p><strong>Note:</strong> This method should perform an expiration check, and if it has
     * expired remove the session and return empty. This method should also update the
