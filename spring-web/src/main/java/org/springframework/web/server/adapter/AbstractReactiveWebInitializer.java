...
public abstract class AbstractReactiveWebInitializer implements WebApplicationInitializer {
    ...
    /**
     * Return the Spring configuration that contains application beans including the ones detected
     * by {@link WebHttpHandlerBuilder#applicationContext}.
     */
    protected ApplicationContext createApplicationContext() {
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext();
        Class<?>[] configClasses = getConfigClasses();
        Assert.notEmpty(
                configClasses, "No Spring configuration provided through getConfigClasses()");
    ...
    /**
     * Return the Servlet mapping to use. Only the default Servlet mapping '/' and path-based
     * Servlet mappings such as '/api/*' are supported.
     *
