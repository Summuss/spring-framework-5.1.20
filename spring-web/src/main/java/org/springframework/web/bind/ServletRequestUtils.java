...
public abstract class ServletRequestUtils {
     ...
     * @throws ServletRequestBindingException a subclass of ServletException, so it doesn't need to
     *     be caught
     */
    @Nullable
    ...
    /**
     * Get a Float parameter, or {@code null} if not present. Throws an exception if it the
     * parameter value isn't a number.
     *
     * @param request current HTTP request
     * @param name the name of the parameter
    ...
    /**
     * Get a Double parameter, or {@code null} if not present. Throws an exception if it the
     * parameter value isn't a number.
     *
     * @param request current HTTP request
     * @param name the name of the parameter
    ...
    public static double getDoubleParameter(
            ServletRequest request, String name, double defaultVal) {
        if (request.getParameter(name) == null) {
            return defaultVal;
        }
        try {
    ...
    /**
     * Get an array of boolean parameters, throwing an exception if not found or one isn't a
     * boolean.
     *
     * <p>Accepts "true", "on", "yes" (any case) and "1" as values for true; treats every other
     * non-empty value as false (i.e. parses leniently).
    ...
    public static String getStringParameter(
            ServletRequest request, String name, String defaultVal) {
