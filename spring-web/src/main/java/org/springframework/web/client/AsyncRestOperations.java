...
public interface AsyncRestOperations {
     ...
     * returns the value of the {@code Location} header. This header typically indicates where the
     ...
     * value of the {@code Location} header. This header typically indicates where the new resource
     * is stored.
     *
     * @param url the URL
     * @param request the Object to be POSTed (may be {@code null})
    ...
    /**
     * Asynchronously execute the HTTP method to the given URL, preparing the request with the
     * {@link AsyncRequestCallback}, and reading the response with a {@link ResponseExtractor}.
     *
     * @param url the URL
     * @param method the HTTP method (GET, POST, etc)
     * @param requestCallback object that prepares the request
