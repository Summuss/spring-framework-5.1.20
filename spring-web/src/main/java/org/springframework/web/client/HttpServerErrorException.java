    ...
    public static HttpServerErrorException create(
        ...
        switch (statusCode) {
            case INTERNAL_SERVER_ERROR:
                return new HttpServerErrorException.InternalServerError(
                        statusText, headers, body, charset);
            case NOT_IMPLEMENTED:
                return new HttpServerErrorException.NotImplemented(
                        statusText, headers, body, charset);
            case BAD_GATEWAY:
            ...
            case GATEWAY_TIMEOUT:
                return new HttpServerErrorException.GatewayTimeout(
                        statusText, headers, body, charset);
            default:
