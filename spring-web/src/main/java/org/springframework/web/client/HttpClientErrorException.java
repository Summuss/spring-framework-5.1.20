...
public class HttpClientErrorException extends HttpStatusCodeException {
    ...
    public static HttpClientErrorException create(
        ...
        switch (statusCode) {
            ...
            case UNAUTHORIZED:
                return new HttpClientErrorException.Unauthorized(
            ...
            case METHOD_NOT_ALLOWED:
                return new HttpClientErrorException.MethodNotAllowed(
                        statusText, headers, body, charset);
            case NOT_ACCEPTABLE:
                return new HttpClientErrorException.NotAcceptable(
                        statusText, headers, body, charset);
            case CONFLICT:
            ...
            case TOO_MANY_REQUESTS:
                return new HttpClientErrorException.TooManyRequests(
                        statusText, headers, body, charset);
            case UNPROCESSABLE_ENTITY:
                return new HttpClientErrorException.UnprocessableEntity(
                        statusText, headers, body, charset);
            default:
