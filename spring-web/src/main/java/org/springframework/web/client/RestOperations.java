...
public interface RestOperations {
    ...
    /**
     * Retrieve an entity by doing a GET on the specified URL. The response is converted and stored
     * in an {@link ResponseEntity}.
     *
     * <p>URI Template variables are expanded using the given URI variables, if any.
     *
     * @param url the URL
    ...
    /**
     * Create a new resource by POSTing the given object to the URI template, and returns the value
     * of the {@code Location} header. This header typically indicates where the new resource is
     * stored.
     *
     * <p>URI Template variables are expanded using the given URI variables, if any.
     *
     ...
     * org.springframework.util.MultiValueMap MultiValueMap} to create a multipart request. The
     * values in the {@code MultiValueMap} can be any Object representing the body of the part, or
     * an {@link org.springframework.http.HttpEntity HttpEntity} representing a part with body and
     * headers.
     *
     * @param url the URL
    ...
    /**
     * Update a resource by PATCHing the given object to the URL, and return the representation
     * found in the response.
     *
     * <p>The {@code request} parameter can be a {@link HttpEntity} in order to add additional HTTP
     * headers to the request.
     ...
     * {@link ResponseEntity}. Typically used in combination with the static builder methods on
     * {@code RequestEntity}, for instance:
     *
     * <pre class="code">
     * MyRequest body = ...
