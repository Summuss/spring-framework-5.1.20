    ...
    private void writeRequestParametersToCachedContent() {
        try {
                ...
                for (Iterator<String> nameIterator = form.keySet().iterator();
                    ...
                    for (Iterator<String> valueIterator = values.iterator();
                        ...
                        this.cachedContent.write(
                                URLEncoder.encode(name, requestEncoding).getBytes());
                        if (value != null) {
                            this.cachedContent.write('=');
                            this.cachedContent.write(
                                    URLEncoder.encode(value, requestEncoding).getBytes());
            ...
            throw new IllegalStateException(
                    "Failed to write request parameters to cached content", ex);
        }
    }
