...
public abstract class TagUtils {
     ...
     * @throws IllegalArgumentException if either of the supplied arguments is {@code null}; or if
     *     the supplied {@code ancestorTagClass} is not type-assignable to the {@link Tag} class
     */
