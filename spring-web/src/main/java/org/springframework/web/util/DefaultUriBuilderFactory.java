...
public class DefaultUriBuilderFactory implements UriBuilderFactory {
     ...
     *
     * <p><strong>Note:</strong> In 5.1 the default was changed from {@link
     * EncodingMode#URI_COMPONENT EncodingMode.URI_COMPONENT}. Consequently the {@code WebClient},
     * which relies on the built-in default has also been switched to the new default. The {@code
     * RestTemplate} however sets this explicitly to {@link EncodingMode#URI_COMPONENT
     * EncodingMode.URI_COMPONENT} explicitly for historic and backwards compatibility reasons.
     *
