...
/**
 * Encapsulates information about an {@linkplain ControllerAdvice @ControllerAdvice} Spring-managed
 * bean without necessarily requiring it to be instantiated.
 *
...
public class ControllerAdviceBean implements Ordered {
    ...
    /**
     * Returns the order value extracted from the {@link ControllerAdvice} annotation, or {@link
    ...
    public Class<?> getBeanType() {
        Class<?> beanType =
                (this.bean instanceof String
                        ? obtainBeanFactory().getType((String) this.bean)
                        : this.bean.getClass());
    ...
    public Object resolveBean() {
        return (this.bean instanceof String
                ? obtainBeanFactory().getBean((String) this.bean)
                : this.bean);
    }
    ...
    /**
     * Check whether the given bean type should be assisted by this {@code @ControllerAdvice}
     * instance.
     *
    ...
    /**
     * Find the names of beans annotated with {@linkplain ControllerAdvice @ControllerAdvice} in the
     * given ApplicationContext and wrap them as {@code ControllerAdviceBean} instances.
     */
    ...
    private static int initOrderFromBean(Object bean) {
        return (bean instanceof Ordered
                ? ((Ordered) bean).getOrder()
                : initOrderFromBeanType(bean.getClass()));
    }
