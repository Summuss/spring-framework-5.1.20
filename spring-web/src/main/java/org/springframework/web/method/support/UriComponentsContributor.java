...
public interface UriComponentsContributor {
    ...
    /**
     * Process the given method argument and either update the {@link UriComponentsBuilder} or add
     * to the map with URI variables to use to expand the URI after all arguments are processed.
     *
