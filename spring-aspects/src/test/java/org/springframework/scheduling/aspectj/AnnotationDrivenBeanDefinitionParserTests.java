...
public class AnnotationDrivenBeanDefinitionParserTests {
    ...
    public void asyncAspectRegistered() {
        assertTrue(
                context.containsBean(TaskManagementConfigUtils.ASYNC_EXECUTION_ASPECT_BEAN_NAME));
    }
    ...
    public void asyncPostProcessorExecutorReference() {
        ...
        assertSame(
                executor,
                ((Supplier) new DirectFieldAccessor(aspect).getPropertyValue("defaultExecutor"))
                        .get());
    }
