...
public class XsltView extends AbstractUrlBasedView {
     ...
     * used that simply logs warnings using the logger instance of the view class, and rethrows
    ...
    /**
     * Set whether the XSLT transformer may add additional whitespace when outputting the result
     * tree.
     *
     ...
     *
     * <p>The default value is "true". Only set this to "false" in development, where caching does
     * not seriously impact performance.
     */
     ...
     * javax.xml.transform.TransformerFactory#newInstance()}. If a {@link
     * #setTransformerFactoryClass "transformerFactoryClass"} has been specified explicitly, the
     * default constructor of the specified class will be called instead.
     *
        ...
        try {
            ...
            if (source == null) {
                throw new IllegalArgumentException(
                        "Unable to locate Source object in model: " + model);
            }
     ...
     * default implementation first attempts to look under the configured {@link #setSourceKey
     * source key}, if any, before attempting to locate an object of {@link #getSourceTypes()
     * supported type}.
     *
    ...
    /**
     * Return the array of {@link Class Classes} that are supported when converting to an XSLT
     * {@link Source}.
     *
    ...
    /**
     * Copy all entries from the supplied Map into the {@link Transformer#setParameter(String,
     * Object) parameter set} of the supplied {@link Transformer}.
     *
     * @param model merged output Map (never {@code null})
     * @param transformer the target transformer
     */
     ...
     *
     * <p>The default implementation of this method sets the {@link
     * HttpServletResponse#setContentType content type} and {@link
     * HttpServletResponse#setCharacterEncoding encoding} from the "media-type" and "encoding"
     * output properties specified in the {@link Transformer}.
     *
     * @param model merged output Map (never {@code null})
     * @param response current HTTP response
     * @param transformer the target transformer
    ...
    private Templates loadTemplates() throws ApplicationContextException {
        ...
        try {
            ...
            throw new ApplicationContextException(
                    "Can't load stylesheet from '" + getUrl() + "'", ex);
        } finally {
    ...
    protected Source getStylesheetSource() {
        ...
        try {
            ...
            throw new ApplicationContextException(
                    "Can't load XSLT stylesheet from '" + url + "'", ex);
        }
    }
