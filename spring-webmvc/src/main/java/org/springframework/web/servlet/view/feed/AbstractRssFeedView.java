...
public abstract class AbstractRssFeedView extends AbstractFeedView<Channel> {
    ...
    /**
     * Invokes {@link #buildFeedItems(Map, HttpServletRequest, HttpServletResponse)} to get a list
     * of feed items.
     */
    @Override
     ...
     * other HTTP headers. The built feed itself will automatically get written to the response
