...
public interface FlashMapManager {
    ...
    /**
     * Find a FlashMap saved by a previous request that matches to the current request, remove it
    ...
    /**
     * Save the given FlashMap, in some underlying storage and set the start of its expiration
     * period.
     *
