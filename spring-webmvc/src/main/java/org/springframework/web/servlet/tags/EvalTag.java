...
public class EvalTag extends HtmlEscapingAwareTag {
    ...
    public int doEndTag() throws JspException {
        EvaluationContext evaluationContext =
                (EvaluationContext)
                        this.pageContext.getAttribute(EVALUATION_CONTEXT_PAGE_ATTRIBUTE);
        ...
        if (this.var != null) {
            ...
            try {
                ...
                result =
                        (this.javaScriptEscape ? JavaScriptUtils.javaScriptEscape(result) : result);
        ...
        private Object resolveImplicitVariable(String name) throws AccessException {
            ...
            try {
                ...
                throw new AccessException(
                        "Unexpected exception occurred accessing '"
                                + name
