...
public abstract class AbstractPdfView extends AbstractView {
    ...
    /**
     * Prepare the given PdfWriter. Called before building the PDF document, that is, before the
     * call to {@code Document.open()}.
     *
     ...
     * Default is an empty implementation. Subclasses may override this method to add meta fields
     * such as title, subject, author, creator, keywords, etc. This method is called after assigning
