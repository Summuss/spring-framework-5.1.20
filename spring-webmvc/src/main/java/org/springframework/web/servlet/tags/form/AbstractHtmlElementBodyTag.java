...
public abstract class AbstractHtmlElementBodyTag extends AbstractHtmlElementTag implements BodyTag {
     ...
     * rendering to occur always, Subclasses can override this if they provide conditional
     * rendering.
     */
    ...
    /**
     * The user customised the output of the error messages - flush the buffered content into the
     * main {@link javax.servlet.jsp.JspWriter}.
     */
