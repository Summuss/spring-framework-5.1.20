...
class OptionWriter {
    ...
    /**
     * Write the '{@code option}' tags for the configured {@link #optionSource} to the supplied
     * {@link TagWriter}.
     */
    ...
    /**
     * Render the inner '{@code option}' tags using the supplied {@link Collection} of objects as
     * the source. The value of the {@link #valueProperty} field is used when rendering the '{@code
    ...
    private String getDisplayString(@Nullable Object value) {
        PropertyEditor editor =
                (value != null ? this.bindStatus.findEditor(value.getClass()) : null);
