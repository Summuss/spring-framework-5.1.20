...
public class ServletRequestMethodArgumentResolverTests {
    ...
    public void servletRequest() throws Exception {
        ...
        assertTrue(
                "ServletRequest not supported",
                resolver.supportsParameter(servletRequestParameter));
    ...
    public void httpMethod() throws Exception {
        ...
        assertSame(
                "Invalid result", HttpMethod.valueOf(webRequest.getRequest().getMethod()), result);
    }
