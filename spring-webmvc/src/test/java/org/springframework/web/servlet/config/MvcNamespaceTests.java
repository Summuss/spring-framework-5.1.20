...
public class MvcNamespaceTests {
    ...
    public void testDefaultConfig() throws Exception {
        ...
        assertSame(
                appContext.getBean(ConversionService.class),
        ...
        assertEquals(
                ...
                introspector.getHandlerMappings().get(1).getClass());
    }
    ...
    public void testCustomConversionService() throws Exception {
        ...
        assertSame(
                appContext.getBean("conversionService"),
                request.getAttribute(ConversionService.class.getName()));
    ...
    public void testResourcesWithResolversTransformers() throws Exception {
        ...
        assertThat(
                versionResolver.getStrategyMap().get("/**/*.js"),
                Matchers.instanceOf(FixedVersionStrategy.class));
        assertThat(
                versionResolver.getStrategyMap().get("/**"),
    ...
    public void testResourcesWithResolversTransformersCustom() throws Exception {
        ...
        assertThat(
                handler.getCacheControl().getHeaderValue(),
                Matchers.equalTo(
    ...
    public void testContentNegotiationManager() throws Exception {
        ...
        NativeWebRequest webRequest = new ServletWebRequest(request);
        assertEquals(
                Collections.singletonList(MediaType.valueOf("application/rss+xml")),
                manager.resolveMediaTypes(webRequest));
        ...
        assertEquals(
                "Actual: " + compositeResolver.getViewResolvers(),
                1,
                compositeResolver.getViewResolvers().size());
    ...
    public void testAsyncSupportOptions() throws Exception {
        ...
        assertEquals(
                ...
                fieldAccessor.getPropertyValue("taskExecutor").getClass());
    ...
    public void testViewResolution() throws Exception {
        ...
        assertArrayEquals(
                new String[] {"my*", "*Report"}, (String[]) accessor.getPropertyValue("viewNames"));
        ...
        assertEquals(
                UnresolvingLocaleDefinitionsFactory.class,
                accessor.getPropertyValue("definitionsFactoryClass"));
        assertEquals(
                SpringBeanPreparerFactory.class, accessor.getPropertyValue("preparerFactoryClass"));
        ...
        assertArrayEquals(
                new String[] {"/", "/test"},
                (String[]) accessor.getPropertyValue("templateLoaderPaths"));
    ...
    public void testCorsMinimal() throws Exception {
        ...
        for (String beanName : beanNames) {
            ...
            assertArrayEquals(
                    new String[] {"GET", "HEAD", "POST"}, config.getAllowedMethods().toArray());
    ...
    public void testCors() throws Exception {
        ...
        for (String beanName : beanNames) {
            ...
            assertArrayEquals(
                    ...
                    config.getAllowedHeaders().toArray());
            assertArrayEquals(
                    new String[] {"header1", "header2"}, config.getExposedHeaders().toArray());
            assertFalse(config.getAllowCredentials());
            assertEquals(Long.valueOf(123), config.getMaxAge());
            config = configs.get("/resources/**");
            assertArrayEquals(
                    new String[] {"https://domain1.com"}, config.getAllowedOrigins().toArray());
            assertArrayEquals(
                    new String[] {"GET", "HEAD", "POST"}, config.getAllowedMethods().toArray());
            assertArrayEquals(new String[] {"*"}, config.getAllowedHeaders().toArray());
            assertNull(config.getExposedHeaders());
