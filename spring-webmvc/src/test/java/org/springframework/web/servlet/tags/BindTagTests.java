...
public class BindTagTests extends AbstractTagTests {
    ...
    public void bindTagWithoutErrors() throws JspException {
        ...
        assertTrue(
                "Correct errorMessagesAsString", "".equals(status.getErrorMessagesAsString(",")));
    }
    ...
    public void bindTagWithGlobalErrors() throws JspException {
        ...
        assertTrue(
                "Correct errorMessagesAsString",
                "message1".equals(status.getErrorMessagesAsString(",")));
    ...
    public void bindStatusGetErrorMessagesAsString() throws JspException {
        ...
        BindStatus status =
                (BindStatus)
                        pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
        assertEquals(
                "Error messages String should be 'message1'",
                "message1",
        ...
        status =
                (BindStatus)
                        pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
        assertEquals(
                "Error messages String should be 'message1,message2'",
                "message1,message2",
                status.getErrorMessagesAsString(","));
        ...
        status =
                (BindStatus)
                        pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
        assertEquals(
                "Error messages String should be ''", "", status.getErrorMessagesAsString(","));
    }
    ...
    public void bindTagWithFieldErrors() throws JspException {
        ...
        assertTrue(
                "Correct errorMessagesAsString",
                "message2".equals(status.getErrorMessagesAsString(" - ")));
    ...
    public void bindErrorsTagWithoutErrors() throws JspException {
        ...
        assertTrue(
                "Doesn't have errors variable",
                pc.getAttribute(BindErrorsTag.ERRORS_VARIABLE_NAME) == null);
    }
    ...
    public void nestedPathWithBindTag() throws JspException {
        ...
        assertTrue(
                "Correct doStartTag return value", bindTag.doStartTag() == Tag.EVAL_BODY_INCLUDE);
        BindStatus status =
                (BindStatus)
                        pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
        assertTrue("Has status variable", status != null);
        ...
        assertTrue(
                "Correct doStartTag return value", bindTag2.doStartTag() == Tag.EVAL_BODY_INCLUDE);
        BindStatus status2 =
                (BindStatus)
                        pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
