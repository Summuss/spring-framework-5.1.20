...
public class ViewResolverTests {
    ...
    private void doTestUrlBasedViewResolverWithoutPrefixes(UrlBasedViewResolver vr)
        ...
        assertSame(
                "View not initialized as bean", wac, ((RedirectView) view).getApplicationContext());
    ...
    private void doTestUrlBasedViewResolverWithPrefixes(UrlBasedViewResolver vr) throws Exception {
        ...
        assertEquals("Correct view class", JstlView.class, view.getClass());
        assertEquals(
                "Correct URL", "/WEB-INF/example1.jsp", ((InternalResourceView) view).getUrl());

        view = vr.resolveViewName("example2", Locale.getDefault());
        assertEquals("Correct view class", JstlView.class, view.getClass());
        assertEquals(
                "Correct URL", "/WEB-INF/example2.jsp", ((InternalResourceView) view).getUrl());
    ...
    public void testInternalResourceViewResolverWithJstl() throws Exception {
        ...
        LocalizationContext lc =
                (LocalizationContext) Config.get(request, Config.FMT_LOCALIZATION_CONTEXT);
    ...
    public void testXmlViewResolver() throws Exception {
        ...
        assertTrue(
                "Correct URL", "/example2new.jsp".equals(((InternalResourceView) view2).getUrl()));
        ...
        public void setLocation(Resource location) {
            if (!(location instanceof ServletContextResource)) {
                throw new IllegalArgumentException(
                        "Expecting ClassPathResource, not " + location.getClass().getName());
            }
        }
    }
}
