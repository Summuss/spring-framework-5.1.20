...
public class DispatcherServletTests {
    ...
    public void configuredDispatcherServlets() {
        ...
        assertTrue(
                ...
                getServletContext()
                                .getAttribute(FrameworkServlet.SERVLET_CONTEXT_PREFIX + "complex")
                        == null);
    ...
    public void unknownRequest() throws Exception {
        ...
        assertTrue(
                "Exception exposed",
                request.getAttribute("exception").getClass().equals(ServletException.class));
    }
    ...
    public void simpleMappingExceptionResolverWithSpecificHandler1() throws Exception {
        ...
        assertTrue(
                "Exception exposed",
                request.getAttribute("exception") instanceof IllegalAccessException);
    }
    ...
    public void simpleMappingExceptionResolverWithSpecificHandler2() throws Exception {
        ...
        assertTrue(
                "Exception exposed", request.getAttribute("exception") instanceof ServletException);
    }
    ...
    public void simpleMappingExceptionResolverWithDefaultErrorView() throws Exception {
        ...
        assertTrue(
                "Exception exposed",
                request.getAttribute("exception").getClass().equals(RuntimeException.class));
    }
    ...
    public void notAuthorized() throws Exception {
        ...
        try {
            complexDispatcherServlet.service(request, response);
            assertTrue(
                    "Correct response", response.getStatus() == HttpServletResponse.SC_FORBIDDEN);
        } catch (ServletException ex) {
            fail("Should not have thrown ServletException: " + ex.getMessage());
        }
    }
    ...
    public void cleanupAfterIncludeWithRemove() throws ServletException, IOException {
        ...
        assertEquals(
                wac, request.getAttribute(DispatcherServlet.WEB_APPLICATION_CONTEXT_ATTRIBUTE));
    ...
    public void allowedOptionsIncludesPatchMethod() throws Exception {
        ...
        assertThat(
                ...
                equalTo("GET, HEAD, POST, PUT, DELETE, TRACE, OPTIONS, PATCH"));
    }
