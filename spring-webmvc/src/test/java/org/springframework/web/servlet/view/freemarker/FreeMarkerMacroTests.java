...
public class FreeMarkerMacroTests {
    ...
    public void testForm15() throws Exception {
        ...
        assertTrue(
                "Wrong output: " + output,
                output.contains("<input type=\"checkbox\" id=\"name\" name=\"name\" />"));
    }
