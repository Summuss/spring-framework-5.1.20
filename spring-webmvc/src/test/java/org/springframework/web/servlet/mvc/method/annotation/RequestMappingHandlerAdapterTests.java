...
public class RequestMappingHandlerAdapterTests {
    ...
    public void setAlwaysUseRedirectAttributes() throws Exception {
        ...
        assertTrue(
                "Without RedirectAttributes arg, model should be empty", mav.getModel().isEmpty());
    }
    ...
    private void assertMethodProcessorCount(
        ...
        assertEquals(
                initBinderResolverCount,
                this.handlerAdapter.getInitBinderArgumentResolvers().size());
