...
public class WebMvcConfigurationSupportTests {
    ...
    public void requestMappingHandlerMapping() throws Exception {
        ...
        assertEquals(
                ConversionServiceExposingInterceptor.class, chain.getInterceptors()[0].getClass());
    ...
    public void customArgumentResolvers() {
        ...
        assertEquals(
                TestArgumentResolver.class, adapter.getCustomArgumentResolvers().get(0).getClass());
        assertEquals(1, adapter.getCustomReturnValueHandlers().size());
        assertEquals(
                TestReturnValueHandler.class,
                adapter.getCustomReturnValueHandlers().get(0).getClass());

        assertNotNull(composite);
        assertEquals(3, composite.getExceptionResolvers().size());
        assertEquals(
                ExceptionHandlerExceptionResolver.class,
                composite.getExceptionResolvers().get(0).getClass());
        ...
        assertEquals(
                TestArgumentResolver.class,
                resolver.getCustomArgumentResolvers().get(0).getClass());
        assertEquals(1, resolver.getCustomReturnValueHandlers().size());
        assertEquals(
                TestReturnValueHandler.class,
                resolver.getCustomReturnValueHandlers().get(0).getClass());
    }
    ...
    public void mvcViewResolver() {
        ...
        assertEquals(
                InternalResourceViewResolver.class, resolver.getViewResolvers().get(0).getClass());
