...
public class ContextLoaderTests {
    ...
    public void testContextLoaderListenerWithDefaultContext() {
        ...
        assertTrue(
                "Correct WebApplicationContext exposed in ServletContext",
    ...
    public void testContextLoaderListenerWithCustomizedContextLoader() {
        ...
        ServletContextListener listener =
                new ContextLoaderListener() {
                    ...
                    protected void customizeContext(
                        ...
                        assertEquals(
                                "Verifying that we received the expected ServletContext.", sc, sc);
                        assertFalse(
                                "The ApplicationContext should not yet have been refreshed.",
                                wac.isActive());
        ...
        assertEquals(
                "customizeContext() should have been called.", expectedContents, buffer.toString());
    }
    ...
    public void testClassPathXmlApplicationContext() throws IOException {
        ...
        assertTrue(
                "myinit not evaluated",
                "Roderick".equals(((TestBean) context.getBean("rod")).getName()));
