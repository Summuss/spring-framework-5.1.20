...
public interface JmsOperations {
    ...
    /**
     * Send the given object to the default destination, converting the object to a JMS message with
    ...
    /**
     * Send the given object to the specified destination, converting the object to a JMS message
     * with a configured MessageConverter.
     *
     * @param destination the destination to send this message to
     * @param message the object to convert to a message
     * @throws JmsException converted checked JMSException to unchecked
    ...
    /**
     * Send the given object to the default destination, converting the object to a JMS message with
     * a configured MessageConverter. The MessagePostProcessor callback allows for modification of
    ...
    /**
     * Send the given object to the specified destination, converting the object to a JMS message
     * with a configured MessageConverter. The MessagePostProcessor callback allows for modification
    ...
    /**
     * Receive a message synchronously from the specified destination, but only wait up to a
    ...
    /**
     * Send a message and receive the reply from the specified destination. The {@link
     * MessageCreator} callback creates the message given a Session. A temporary queue is created as
     * part of this operation and is set in the {@code JMSReplyTO} header of the message.
     *
     * @param destination the destination to send this message to
     ...
     * in order to browse the queue and react to the contents.
     *
     * @param queueName the name of the queue to browse (to be resolved to an actual destination by
