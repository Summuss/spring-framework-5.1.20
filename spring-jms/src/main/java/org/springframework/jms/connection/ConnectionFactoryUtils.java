...
public abstract class ConnectionFactoryUtils {
     ...
     * will be unwrapped until a non-proxy Session is found. Otherwise, the passed-in Session will
     * be returned as-is.
     *
    ...
    /**
     * Determine whether the given JMS Session is transactional, that is, bound to the current
     ...
     *     JDBC-based one for a specific DataSource, for example), with the JMS transaction
     *     committing right after the main transaction. If not allowed, the given ConnectionFactory
     ...
     * Obtain a JMS Session that is synchronized with the current transaction, if any.
     *
     * <p>This {@code doGetTransactionalSession} variant always starts the underlying JMS
     ...
     *     order to allow for receiving messages. Note that a reused Connection may already have
     *     been started before, even if this flag is {@code false}.
     * @return the transactional Session, or {@code null} if none found
     * @throws JMSException in case of JMS failure
     */
    @Nullable
    ...
    public interface ResourceFactory {
         ...
         * specific DataSource, for example), with the JMS transaction committing right after the
         * main transaction.
         *
