...
public interface JmsHeaders {
    ...
    /**
     * Specify if the message was resent. This occurs when a message consumer fails to acknowledge
    ...
    /**
     * Message type label. This type is a string value describing the message in a functional
     * manner.
     *
