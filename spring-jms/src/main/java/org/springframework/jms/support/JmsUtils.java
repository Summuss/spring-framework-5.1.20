...
public abstract class JmsUtils {
    ...
    /**
     * Close the given JMS MessageProducer and ignore any thrown exception. This is useful for
    ...
    /**
     * Close the given JMS MessageConsumer and ignore any thrown exception. This is useful for
     * typical {@code finally} blocks in manual JMS code.
     *
    ...
    /**
     * Close the given JMS QueueRequestor and ignore any thrown exception. This is useful for
     * typical {@code finally} blocks in manual JMS code.
     *
    ...
    public static JmsException convertJmsAccessException(JMSException ex) {
        ...
        if (ex instanceof javax.jms.TransactionInProgressException) {
            return new TransactionInProgressException(
                    (javax.jms.TransactionInProgressException) ex);
        }
        if (ex instanceof javax.jms.TransactionRolledBackException) {
            return new TransactionRolledBackException(
                    (javax.jms.TransactionRolledBackException) ex);
        }
