...
public abstract class AbstractJmsAnnotationDrivenTests {
    ...
    public void testCustomConfiguration(ApplicationContext context) {
        ...
        assertEquals(
                "Wrong listener set in custom endpoint",
                context.getBean("simpleMessageListener"),
        ...
        assertEquals(
                "Wrong number of containers in the registry",
                2,
     ...
     */
    public void testJmsHandlerMethodFactoryConfiguration(ApplicationContext context)
            throws JMSException {
        JmsListenerContainerTestFactory simpleFactory =
