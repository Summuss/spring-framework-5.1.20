...
public class PersistenceXmlParsingTests {
    ...
    public void testMetaInfCase() throws Exception {
        ...
        assertEquals(
                ...
                info[0].getJarFileUrls().get(1));

        assertFalse(
                "Exclude unlisted should default false in 1.0.", info[0].excludeUnlistedClasses());
    }
    ...
    public void testExample4() throws Exception {
        ...
        assertTrue(
                "Exclude unlisted should be true when no value.", info[0].excludeUnlistedClasses());
    ...
    public void testPersistenceUnitRootUrl() throws Exception {
        ...
        assertTrue(
                "the containing folder should have been returned",
                url.toString().endsWith("/org/springframework/orm/jpa"));
    }
    ...
    public void testPersistenceUnitRootUrlWithJar() throws Exception {
        ...
        assertTrue(
                "the archive location should have been returned", archive.getURL().sameFile(url));
    }
    ...
    public void testJpa1ExcludeUnlisted() throws Exception {
        ...
        assertEquals(
                "noExclude name is not correct.",
                "NoExcludeElement",
                noExclude.getPersistenceUnitName());
        assertFalse(
                "Exclude unlisted should default false in 1.0.",
                noExclude.excludeUnlistedClasses());

        PersistenceUnitInfo emptyExclude = info[1];
        assertNotNull("emptyExclude should not be null.", emptyExclude);
        assertEquals(
                "emptyExclude name is not correct.",
                "EmptyExcludeElement",
                emptyExclude.getPersistenceUnitName());
        ...
        assertEquals(
                "trueExclude name is not correct.",
                "TrueExcludeElement",
                trueExclude.getPersistenceUnitName());
        ...
        assertEquals(
                "falseExclude name is not correct.",
                "FalseExcludeElement",
                falseExclude.getPersistenceUnitName());
    ...
    public void testJpa2ExcludeUnlisted() throws Exception {
        ...
        assertEquals(
                ...
                noExclude.getPersistenceUnitName());
        assertFalse(
                "Exclude unlisted still defaults to false in 2.0.",
                noExclude.excludeUnlistedClasses());
