...
public class HibernateEntityManagerFactoryIntegrationTests
    ...
    public void testCanCastNativeEntityManagerFactoryToHibernateEntityManagerFactoryImpl() {
        ...
        assertTrue(
                emfi.getNativeEntityManagerFactory()
                        instanceof SessionFactory); // as of Hibernate 5.2
    }
    ...
    public void testCanCastSharedEntityManagerProxyToHibernateEntityManager() {
        ...
        assertTrue(
                ((EntityManagerProxy) sharedEntityManager).getTargetEntityManager()
                        instanceof Session); // as of Hibernate 5.2
    }
    ...
    public void testReadOnly() {
        assertSame(
                FlushMode.AUTO, sharedEntityManager.unwrap(Session.class).getHibernateFlushMode());
        ...
        assertSame(
                FlushMode.MANUAL,
                sharedEntityManager.unwrap(Session.class).getHibernateFlushMode());
