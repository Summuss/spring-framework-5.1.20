...
public interface HibernateOperations {
    ...
    /**
     * Execute the action specified by the given action object within a {@link
     * org.hibernate.Session}.
     *
     * <p>Application exceptions thrown by the action object get propagated to the caller (can only
     * be unchecked). Hibernate exceptions are transformed into appropriate DAO ones. Allows for
     ...
     * transaction manager like {@link HibernateTransactionManager}. Generally, callback code must
     * not touch any {@code Session} lifecycle methods, like close, disconnect, or reconnect, to let
     ...
     * null} if not found.
     *
     * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(Class,
     ...
     * LockMode)} for convenience. For an explanation of the exact semantics of this method, please
     ...
     * null} if not found.
     *
     * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(String,
     * Serializable)} for convenience. For an explanation of the exact semantics of this method,
     * please do refer to the Hibernate API documentation in the first instance.
     *
     ...
     *
     * <p>This method is a thin wrapper around {@link org.hibernate.Session#get(String,
     * Serializable, LockMode)} for convenience. For an explanation of the exact semantics of this
     ...
     *
     * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(Class,
     * Serializable)} for convenience. For an explanation of the exact semantics of this method,
     * please do refer to the Hibernate API documentation in the first instance.
     *
     * @param entityClass a persistent class
    ...
    /**
     * Return the persistent instance of the given entity class with the given identifier, throwing
     * an exception if not found. Obtains the specified lock mode if the instance exists.
     *
     * <p>This method is a thin wrapper around {@link org.hibernate.Session#load(Class,
     * Serializable, LockMode)} for convenience. For an explanation of the exact semantics of this
     * method, please do refer to the Hibernate API documentation in the first instance.
     ...
     *
     * <p>Note that {@code merge} will <i>not</i> update the identifiers in the passed-in object
     * graph (in contrast to TopLink)! Consider registering Spring's {@code
     ...
     *
     * <p>Similar to {@code saveOrUpdate}, but never associates the given object with the current
     * Hibernate {@link org.hibernate.Session}. In the case of a new entity, the state will be
     * copied over as well.
     *
     * <p>Note that {@code merge} will <i>not</i> update the identifiers in the passed-in object
     * graph (in contrast to TopLink)! Consider registering Spring's {@code
     ...
     * certain changes within the same transaction. Else, it is preferable to rely on auto-flushing
    ...
    /**
     * Remove all objects from the {@link org.hibernate.Session} cache, and cancel all pending
    ...
    /**
     * Execute a named query, binding a number of values to ":" named parameters in the query
     * string.
     *
     * <p>A named query is defined in a Hibernate mapping file.
     *
    ...
    /**
     * Execute a named query, binding the properties of the given bean to ":" named parameters in
     * the query string.
     *
     * <p>A named query is defined in a Hibernate mapping file.
     *
     ...
     * query string.
     *
     * <p>Returns the results as an {@link Iterator}. Entities returned are initialized on demand.
     * See the Hibernate API documentation for details.
     *
     * @param queryString a query expressed in Hibernate's query language
     * @param values the values of the parameters
