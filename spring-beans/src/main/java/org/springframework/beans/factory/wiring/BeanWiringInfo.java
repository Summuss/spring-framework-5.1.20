...
public class BeanWiringInfo {
     ...
     *
     * @param autowireMode one of the constants {@link #AUTOWIRE_BY_NAME} / {@link
     *     #AUTOWIRE_BY_TYPE}
     * @param dependencyCheck whether to perform a dependency check for object references in the
     *     bean instance (after autowiring)
     * @throws IllegalArgumentException if the supplied {@code autowireMode} is not one of the
     *     allowed values
    ...
    /**
     * Return whether to perform a dependency check for object references in the bean instance
     * (after autowiring).
     */
