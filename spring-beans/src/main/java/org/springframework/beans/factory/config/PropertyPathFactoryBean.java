...
public class PropertyPathFactoryBean
     ...
     *
     * <p>Note: This is not necessary for directly specified target objects or singleton target
     * beans, where the type can be determined through introspection. Just specify this in case of a
     ...
     * pattern, if neither "targetObject" nor "targetBeanName" nor "propertyPath" have been
     * specified. This allows for concise bean definitions with just an id/name.
     */
    @Override
