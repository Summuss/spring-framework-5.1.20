...
public abstract class BeanFactoryAnnotationUtils {
     ...
     * (e.g. via {@code <qualifier>} or {@code @Qualifier}) matching the given qualifier, or having
     * a bean name matching the given qualifier.
     *
    ...
    public static boolean isQualifierMatch(
        ...
        if (beanFactory != null) {
            ...
            try {
                ...
                if (beanFactory instanceof ConfigurableBeanFactory) {
                    ...
                    if (bd instanceof AbstractBeanDefinition) {
                        ...
                        AutowireCandidateQualifier candidate =
                                abd.getQualifier(Qualifier.class.getName());
                        if (candidate != null) {
                            Object value =
                                    candidate.getAttribute(AutowireCandidateQualifier.VALUE_KEY);
                ...
                if (beanType != null) {
                    Qualifier targetAnnotation =
                            AnnotationUtils.getAnnotation(beanType, Qualifier.class);
                    if (targetAnnotation != null) {
                        return qualifier.test(targetAnnotation.value());
                    }
                }
