...
public class ExtendedBeanInfoTests {
    ...
    public void indexedReadMethodReturnsSupertypeOfIndexedWriteMethodParameter()
        ...
        assertEquals(
                hasIndexedWriteMethodForProperty(bi, "foos"),
                hasIndexedWriteMethodForProperty(ebi, "foos"));
    }
    ...
    public void subclassWriteMethodWithCovariantReturnType() throws IntrospectionException {
        ...
        assertThat(
                ebi.getPropertyDescriptors().length, equalTo(bi.getPropertyDescriptors().length));
    }
    ...
    public void propertyCountsWithNonStandardWriteMethod() throws IntrospectionException {
        ...
        assertThat(
                ebi.getPropertyDescriptors().length,
                equalTo(bi.getPropertyDescriptors().length + 1));
    }
    ...
    public void propertyDescriptorOrderIsEqual() throws IntrospectionException {
        ...
        for (int i = 0; i < bi.getPropertyDescriptors().length; i++) {
            assertThat(
                    "element "
                            + i
                            + " in BeanInfo and ExtendedBeanInfo propertyDescriptor arrays do not match",
                    ebi.getPropertyDescriptors()[i].getName(),
                    equalTo(bi.getPropertyDescriptors()[i].getName()));
        }
    }
