...
public class ObjectFactoryCreatingFactoryBeanTests {
    ...
    public void testWhenTargetBeanNameIsNull() throws Exception {
        try {
            ...
            fail(
                    "Must have thrown an IllegalArgumentException; 'targetBeanName' property not set.");
    ...
    public void testWhenTargetBeanNameIsEmptyString() throws Exception {
        try {
            ...
            factory.afterPropertiesSet();
            fail(
                    "Must have thrown an IllegalArgumentException; 'targetBeanName' property set to (invalid) empty string.");
        } catch (IllegalArgumentException expected) {
        }
    }
    ...
    public void testWhenTargetBeanNameIsWhitespacedString() throws Exception {
        try {
            ...
            factory.afterPropertiesSet();
            fail(
                    "Must have thrown an IllegalArgumentException; 'targetBeanName' property set to (invalid) only-whitespace string.");
        } catch (IllegalArgumentException expected) {
        }
    }
    ...
    public void testEnsureOFBFBReportsThatItActuallyCreatesObjectFactoryInstances() {
        assertEquals(
                ...
                ObjectFactory.class,
                new ObjectFactoryCreatingFactoryBean().getObjectType());
    }
