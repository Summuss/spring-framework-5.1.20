...
public abstract class AbstractBeanFactoryTests {
    ...
    public void getInstanceByNonmatchingClass() {
        try {
            ...
            assertTrue(
                    ...
                    TestBean.class.isAssignableFrom(ex.getActualType()));
            assertTrue(
                    "Actual type is correct",
                    ex.getActualType() == getBeanFactory().getBean("rod").getClass());
        }
    }
    ...
    public void xtestTypeMismatch() {
        try {
            ...
            assertTrue(
                    "We have rejected age in exception",
                    ex.getPropertyAccessException("age")
    ...
    public void factorySingleton() throws Exception {
        ...
        assertTrue(
                "Singleton from factory has correct name, not " + tb.getName(),
    ...
    public void factoryIsInitialized() throws Exception {
        ...
        DummyFactory factory = (DummyFactory) getBeanFactory().getBean("&singletonFactory");
        assertTrue(
                "Factory was initialized because it implemented InitializingBean",
                factory.wasInitialized());
    }
