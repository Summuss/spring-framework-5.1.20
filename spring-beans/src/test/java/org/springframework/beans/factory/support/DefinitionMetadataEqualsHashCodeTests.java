...
public class DefinitionMetadataEqualsHashCodeTests {
    ...
    public void rootBeanDefinitionAndMethodOverridesWithDifferentOverloadedValues() {
        ...
        assertEquals(
                "Hash code for equal instances must match", master.hashCode(), equal.hashCode());
    }
    ...
    private void assertEqualsAndHashCodeContracts(
        ...
        assertEquals("Should be equal", master, equal);
        assertEquals(
                "Hash code for equal instances should match", master.hashCode(), equal.hashCode());

        assertNotEquals("Should not be equal", master, notEqual);
        assertNotEquals(
                "Hash code for non-equal instances should not match",
                master.hashCode(),
                notEqual.hashCode());
