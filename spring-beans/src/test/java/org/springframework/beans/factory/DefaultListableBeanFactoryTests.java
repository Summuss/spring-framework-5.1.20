...
public class DefaultListableBeanFactoryTests {
    ...
    public void testEmpty() {
        ...
        assertTrue(
                "No beans defined after no arg constructor",
                lbf.getBeanDefinitionNames().length == 0);
    ...
    public void testHarmlessIgnorableRubbish() {
        ...
        assertTrue(
                "No beans defined after harmless ignorable rubbish",
                lbf.getBeanDefinitionCount() == 0);
    }
    ...
    public void testCanReferenceParentBeanFromChildViaAlias() {
        ...
        assertEquals(
                "Use cached merged bean definition",
    ...
    public void testExpressionInStringArray() {
        ...
        when(beanExpressionResolver.evaluate(
                        eq("#{foo}"), ArgumentMatchers.any(BeanExpressionContext.class)))
    ...
    public void testAutowireBeanWithFactoryBeanByName() {
        ...
        assertNotNull("The FactoryBean should have been registered.", factoryBean);
        lbf.autowire(
                FactoryBeanDependentBean.class, AutowireCapableBeanFactory.AUTOWIRE_BY_NAME, true);
    }
    ...
    public void testSingletonLookupByNameIsFastEnough() {
        ...
        // System.out.println(sw.getTotalTimeMillis());
        assertTrue(
                "Singleton lookup took too long: " + sw.getTotalTimeMillis(),
    ...
    public void testExplicitScopeInheritanceForChildBeanDefinitions() {
        ...
        assertEquals(
                "Child 'scope' not overriding parent scope (it must).",
                theChildScope,
                def.getScope());
    }
