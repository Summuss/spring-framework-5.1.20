...
public abstract class AbstractPropertyAccessorTests {
    ...
    public void setNumberProperties() {
        ...
        assertTrue(
                "Correct short2 value", new Short("2").equals(accessor.getPropertyValue("short2")));
        assertTrue("Correct short2 value", new Short("2").equals(target.getShort2()));
        assertTrue(
                "Correct int2 value", new Integer("8").equals(accessor.getPropertyValue("int2")));
        ...
        assertTrue(
                "Correct bigDecimal value", new BigDecimal("4.0").equals(target.getBigDecimal()));
    }
    ...
    public void setStringArrayProperty() throws Exception {
        ...
        assertTrue(
                "correct values",
                result.contains("foo") && result.contains("fi") && result.contains("fum"));
