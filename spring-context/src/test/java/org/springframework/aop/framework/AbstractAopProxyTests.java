...
public abstract class AbstractAopProxyTests {
    ...
    public void testOneAdvisedObjectCallsAnother() {
        ...
        assertEquals(
                "Advised one spouse has correct age",
                age2,
                advised1.getSpouse().getAge()); // = 4 invocations on 1 and another one on 2
    ...
    public void testTargetCanGetProxy() {
        ...
        assertEquals(
                "3 more invocations via AOP as the first call was reentrant through the proxy",
                4,
                di.getCount());
    }
    ...
    public void testCannotAddDynamicIntroductionAdviceExceptInIntroductionAdvice()
        ...
        try {
            ...
            fail(
                    "Shouldn't be able to add introduction interceptor except via introduction advice");
    ...
    public void testCannotAddIntroductionAdviceWithUnimplementedInterface() throws Throwable {
        ...
        try {
            ...
            fail(
                    "Shouldn't be able to add introduction advice introducing an unimplemented interface");
    ...
    public void testAfterReturningAdvisorIsNotInvokedOnException() {
        ...
        pf.addAdvice(car);
        assertEquals(
                "Advice was wrapped in Advisor and added", car, pf.getAdvisors()[1].getAdvice());
        ITestBean proxied = (ITestBean) createProxy(pf);
