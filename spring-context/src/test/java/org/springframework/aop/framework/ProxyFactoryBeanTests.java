...
public class ProxyFactoryBeanTests {
    ...
    public void testTargetSourceNotAtEndOfInterceptorNamesIsRejected() {
        try {
            ...
            new XmlBeanDefinitionReader(bf)
                    .loadBeanDefinitions(
                            new ClassPathResource(NOTLAST_TARGETSOURCE_CONTEXT, CLASS));
    ...
    public void testGetObjectTypeWithNoTargetOrTargetSource() {
        ...
        assertTrue(
                "Has correct object type", ITestBean.class.isAssignableFrom(pfb.getObjectType()));
    }
    ...
    public void testPrototypeInstancesAreNotEqual() {
        assertTrue(
                "Has correct object type",
                ITestBean.class.isAssignableFrom(factory.getType("prototype")));
    ...
    public void testCanGetFactoryReferenceAndManipulate() {
        ...
        assertTrue(
                "Has correct object type",
                ITestBean.class.isAssignableFrom(config.getObjectType()));
        assertTrue(
                "Has correct object type",
                ITestBean.class.isAssignableFrom(factory.getType("test1")));
    ...
    public void testCanAddAndRemoveAspectInterfacesOnPrototype() {
        assertThat(
                "Shouldn't implement TimeStamped before manipulation",
        ...
        assertThat(
                "Should no longer implement TimeStamped",
                factory.getBean("test2"),
                not(instanceOf(TimeStamped.class)));
    ...
    */
    ...
    public void testSerializableSingletonProxy() throws Exception {
        ...
        assertFalse(
                "Not serializable because an interceptor isn't serializable",
                SerializationTestUtils.isSerializable(p));

        // Remove offending interceptor...
        assertTrue(((Advised) p).removeAdvice(nop));
        assertTrue(
                "Serializable again because offending interceptor was removed",
                SerializationTestUtils.isSerializable(p));
    }
