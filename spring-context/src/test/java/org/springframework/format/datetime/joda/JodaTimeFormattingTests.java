...
public class JodaTimeFormattingTests {
    ...
    public void testBindLocalDateAnnotatedWithError() {
        ...
        assertEquals(
                "Oct 031, 2009", binder.getBindingResult().getFieldValue("localDateAnnotated"));
    }
    ...
    public void testBindNestedLocalDateAnnotated() {
        ...
        assertEquals(
                "Oct 31, 2009",
                binder.getBindingResult().getFieldValue("children[0].localDateAnnotated"));
    }
    ...
    public void testBindDateTimeISO() {
        ...
        assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals(
                "2009-10-31T07:00:00.000-05:00",
                binder.getBindingResult().getFieldValue("dateTime"));
    }
    ...
    public void testBindDateTimeAnnotatedPattern() {
        ...
        assertEquals(
                "10/31/09 12:00 PM",
                binder.getBindingResult().getFieldValue("dateTimeAnnotatedPattern"));
    }
    ...
    public void testBindDateWithErrorAvoidingDateConstructor() {
        ...
        assertEquals(1, binder.getBindingResult().getErrorCount());
        assertEquals(
                "Sat, 12 Aug 1995 13:30:00 GMT", binder.getBindingResult().getFieldValue("date"));
    }
    ...
    public void testBindISODateTime() {
        ...
        assertEquals(
                "2009-10-31T07:00:00.000-05:00",
                binder.getBindingResult().getFieldValue("isoDateTime"));
    }
    ...
    public void testBindInstantAnnotated() {
        ...
        assertEquals(
                "2009-10-31T07:00:00.000-05:00",
                binder.getBindingResult().getFieldValue("instantAnnotated"));
    }
    ...
    public void testBindDuration() {
        ...
        assertEquals(0, binder.getBindingResult().getErrorCount());
        assertTrue(
                binder.getBindingResult().getFieldValue("duration").toString().equals("PT72.345S"));
    }
    ...
    public void testBindYearMonth() {
        ...
        assertEquals(0, binder.getBindingResult().getErrorCount());
        assertTrue(
                binder.getBindingResult().getFieldValue("yearMonth").toString().equals("2007-12"));
    }
    ...
    public void testBindMonthDay() {
        ...
        assertEquals(0, binder.getBindingResult().getErrorCount());
        assertTrue(
                binder.getBindingResult().getFieldValue("monthDay").toString().equals("--12-03"));
    }
