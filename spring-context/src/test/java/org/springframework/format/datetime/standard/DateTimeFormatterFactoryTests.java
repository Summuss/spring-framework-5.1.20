...
public class DateTimeFormatterFactoryTests {
    ...
    public void createDateTimeFormatter() {
        assertThat(
                factory.createDateTimeFormatter().toString(),
    ...
    public void createDateTimeFormatterInOrderOfPropertyPriority() {
        ...
        assertThat(
                applyLocale(factory.createDateTimeFormatter()).format(dateTime), is("2009-10-21"));
    ...
    public void createDateTimeFormatterWithTimeZone() {
        ...
        assertThat(
                factory.createDateTimeFormatter().format(dateTime), is("20091021121000 " + offset));
    }
