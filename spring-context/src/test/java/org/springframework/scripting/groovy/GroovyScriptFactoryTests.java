...
public class GroovyScriptFactoryTests {
    ...
    public void testStaticScript() throws Exception {
        ...
        assertFalse(
                "Scripted object should not be instance of Refreshable",
                calc instanceof Refreshable);
        assertFalse(
                "Scripted object should not be instance of Refreshable",
                messenger instanceof Refreshable);
    ...
    public void testScriptedClassThatDoesNotHaveANoArgCtor() throws Exception {
        ...
        try {
            ...
            fail(
                    "Must have thrown a ScriptCompilationException (no public no-arg ctor in scripted class).");
    ...
    public void testWithTwoClassesDefinedInTheOneGroovyFile_WrongClassFirst() throws Exception {
        try {
            ...
            fail(
                    "Must have failed: two classes defined in GroovyScriptFactory source, non-Messenger class defined first.");
        }
    ...
    public void testWithInlineScriptWithLeadingWhitespace() throws Exception {
        try {
            ...
            fail(
                    "Must have thrown a BeanCreationException ('inline:' prefix was preceded by whitespace");
    ...
    public void testGetScriptedObjectDoesChokeOnNullScriptSourceBeingPassedIn() throws Exception {
        ...
        try {
            ...
            fail(
                    "Must have thrown a NullPointerException as per contract ('null' ScriptSource supplied");
