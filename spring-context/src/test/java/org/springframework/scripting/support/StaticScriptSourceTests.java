...
public class StaticScriptSourceTests {
    ...
    public void gettingScriptTogglesIsModified() throws Exception {
        ...
        assertFalse(
                "Script must be flagged as 'not modified' after script is read.",
                source.isModified());
    }
    ...
    public void gettingScriptViaToStringDoesNotToggleIsModified() throws Exception {
        ...
        source.toString();
        assertEquals(
                "Script's 'modified' flag must not change after script is read via toString().",
                isModifiedState,
                source.isModified());
    }
    ...
    public void isModifiedToggledWhenDifferentScriptIsSet() throws Exception {
        ...
        assertTrue(
                "Script must be flagged as 'modified' when different script is passed in.",
                source.isModified());
    }
    ...
    public void isModifiedNotToggledWhenSameScriptIsSet() throws Exception {
        ...
        assertFalse(
                "Script must not be flagged as 'modified' when same script is passed in.",
                source.isModified());
    }
}
