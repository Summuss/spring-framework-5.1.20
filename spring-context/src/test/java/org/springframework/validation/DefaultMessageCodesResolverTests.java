...
public class DefaultMessageCodesResolverTests {
    ...
    public void shouldResolveMessageCodeWithPrefix() throws Exception {
        ...
        assertThat(
                codes,
                is(equalTo(new String[] {"prefix.errorCode.objectName", "prefix.errorCode"})));
    }
    ...
    public void shouldSupportNullFieldType() throws Exception {
        ...
        assertThat(
                ...
                is(
                        equalTo(
                                new String[] {
                                    "errorCode.objectName.field", "errorCode.field", "errorCode"
                                })));
    }
    ...
    public void shouldSupportCustomFormat() throws Exception {
        ...
        assertThat(
                codes,
                is(equalTo(new String[] {"CUSTOM-errorCode.objectName", "CUSTOM-errorCode"})));
    }
}
