...
public class XmlBeanFactoryTests {
    ...
    public void testRefToSeparatePrototypeInstances() {
        ...
        assertTrue(
                "Emma and georgia think they have a different boyfriend",
    ...
    public void lookupOverrideOneMethodWithConstructorInjection() {
        ...
        assertSame(
                "The two prototypes hold the same singleton reference",
                fm1.getTestBean(),
                fm2.getTestBean());
    }
    ...
    public void testRejectsOverrideOfBogusMethodName() {
        ...
        try {
            ...
            assertTrue(
                    ...
                    ex.getMessage().contains("bogusMethod"));
        }
    }
