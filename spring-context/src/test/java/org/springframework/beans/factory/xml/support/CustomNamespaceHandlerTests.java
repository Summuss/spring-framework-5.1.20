...
public class CustomNamespaceHandlerTests {
    ...
    public void testProxyingDecorator() throws Exception {
        ...
        assertEquals(
                "Incorrect advice class",
                DebugInterceptor.class,
                advisors[0].getAdvice().getClass());
    }
    ...
    public void testProxyingDecoratorNoInstance() throws Exception {
        ...
        assertEquals(
                ApplicationListener.class, this.beanFactory.getType("debuggingTestBeanNoInstance"));
        try {
    ...
    public void testChainedDecorators() throws Exception {
        ...
        assertEquals(
                ...
                advisors[0].getAdvice().getClass());
        assertEquals(
                "Incorrect advice class", NopInterceptor.class, advisors[1].getAdvice().getClass());
    }
