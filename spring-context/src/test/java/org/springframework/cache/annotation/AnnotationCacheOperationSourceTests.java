...
public class AnnotationCacheOperationSourceTests {
    ...
    public void singleComposedAnnotation() {
        ...
        assertThat(
                cacheOperation.getCacheNames(),
                equalTo(Collections.singleton("directly declared")));
    ...
    public void multipleComposedAnnotations() {
        ...
        assertThat(
                cacheOperation.getCacheNames(),
                equalTo(Collections.singleton("composedCacheEvict")));
    ...
    private Collection<CacheOperation> getOps(
        ...
        assertEquals(
                "Wrong number of operation(s) for '" + name + "'",
    ...
    private void assertSharedConfig(
        ...
        assertEquals(
                "Wrong number of cache names", cacheNames.length, actual.getCacheNames().size());
