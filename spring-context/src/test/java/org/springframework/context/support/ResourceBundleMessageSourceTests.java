...
public class ResourceBundleMessageSourceTests {
    ...
    protected void doTestMessageAccess(
        ...
        assertEquals(
                "Arg1, Arg2",
                ac.getMessage("hello", new Object[] {"Arg1", "Arg2"}, Locale.ENGLISH));
    ...
    public void testDefaultApplicationContextMessageSource() {
        ...
        assertEquals(
                "default value",
                ac.getMessage("code1", new Object[] {"value"}, "default {0}", Locale.ENGLISH));
    }
    ...
    public void testReloadableResourceBundleMessageSourceWithCommonMessages() {
        ...
        assertEquals("nachricht2", ms.getMessage("code2", null, Locale.GERMAN));
        assertEquals(
                "Do not do this", ms.getMessage("warning", new Object[] {"this"}, Locale.ENGLISH));
        assertEquals(
                "Do not do that", ms.getMessage("warning", new Object[] {"that"}, Locale.GERMAN));
    }
