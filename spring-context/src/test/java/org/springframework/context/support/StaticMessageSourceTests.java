...
public class StaticMessageSourceTests extends AbstractApplicationContextTests {
    ...
    public void messageSourceResolvable() {
        ...
        assertTrue(
                ...
                MSG_TXT3_US.equals(sac.getMessage(resolvable1, Locale.US)));
        ...
        assertTrue(
                "correct message retrieved",
                MSG_TXT2_US.equals(sac.getMessage(resolvable2, Locale.US)));
        ...
        assertTrue(
                "correct message retrieved",
                "default".equals(sac.getMessage(resolvable3, Locale.US)));
