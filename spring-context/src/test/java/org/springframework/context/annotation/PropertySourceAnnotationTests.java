...
public class PropertySourceAnnotationTests {
    ...
    public void withExplicitName() {
        ...
        ctx.refresh();
        assertTrue(
                "property source p1 was not added",
    ...
    public void orderingWithAndWithoutNameAndMultipleResourceLocations() {
        ...
        AnnotationConfigApplicationContext ctxWithoutName =
                new AnnotationConfigApplicationContext(ConfigWithMultipleResourceLocations.class);
        assertThat(
                ctxWithoutName.getEnvironment().getProperty("testbean.name"),
                equalTo("p2TestBean"));
        assertThat(
                ctxWithName.getEnvironment().getProperty("testbean.name"), equalTo("p2TestBean"));
    }
