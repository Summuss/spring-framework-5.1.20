...
public class BeanAnnotationAttributePropagationTests {
    ...
    public void autowireMetadataIsPropagated() {
        ...
        assertEquals(
                ...
                beanDef(Config.class).getAutowireMode());
    }
    ...
    public void initMethodMetadataIsPropagated() {
        ...
        assertEquals(
                "init method name was not propagated",
                "start",
                beanDef(Config.class).getInitMethodName());
    }
    ...
    public void destroyMethodMetadataIsPropagated() {
        ...
        assertEquals(
                "destroy method name was not propagated",
                "destroy",
                beanDef(Config.class).getDestroyMethodName());
    }
    ...
    public void dependsOnMetadataIsPropagated() {
        ...
        assertArrayEquals(
                "dependsOn metadata was not propagated",
                new String[] {"bar", "baz"},
    ...
    public void primaryMetadataIsFalseByDefault() {
        ...
        assertFalse(
                "@Bean methods should be non-primary by default",
    ...
    public void lazyMetadataIsFalseByDefault() {
        ...
        assertFalse(
                "@Bean methods should be non-lazy by default", beanDef(Config.class).isLazyInit());
    }
    ...
    public void eagerConfigurationProducesEagerBeanDefinitions() {
        ...
        assertFalse(
                "@Lazy(false) @Configuration should produce eager bean definitions",
                beanDef(Config.class).isLazyInit());
    }
