...
public class NestedConfigurationClassTests {
    ...
    public void twoLevelsDeep() {
        ...
        assertFalse(
                ctx.getBeanFactory().containsSingleton("nestedConfigurationClassTests.L0Config"));
        ...
        assertFalse(
                ctx.getBeanFactory().containsSingleton(L0Config.L1Config.L2Config.class.getName()));
        ctx.getBean(L0Config.L1Config.L2Config.class);
        ctx.getBean("l2Bean");
