...
public class ClassPathBeanDefinitionScannerTests {
    ...
    public void testSimpleScanWithDefaultFiltersAndPostProcessors() {
        ...
        assertTrue(
                context.containsBean(AnnotationConfigUtils.COMMON_ANNOTATION_PROCESSOR_BEAN_NAME));
    ...
    public void testMultipleScanCalls() {
        ...
        assertEquals(
                initialBeanCount + scannedBeanCount + addedBeanCount,
    ...
    public void testAutowireCandidatePatternDoesNotMatch() {
        ...
        try {
            ...
            context.getBean("fooService");
            fail(
                    "BeanCreationException expected; fooDao should not have been an autowire-candidate");
        } catch (BeanCreationException expected) {
