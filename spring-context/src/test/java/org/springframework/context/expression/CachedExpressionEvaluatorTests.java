...
public class CachedExpressionEvaluatorTests {
    ...
    public void cacheExpression() {
        ...
        hasParsedExpression("true");
        assertEquals(
                "Only one expression should be in cache", 1, expressionEvaluator.testCache.size());
    }
    ...
    public void cacheExpressionBasedOnConcreteType() {
        ...
        assertEquals(
                "Cached expression should be based on type",
                2,
                expressionEvaluator.testCache.size());
    }
