...
public class JmxUtilsTests {
    ...
    public void testSimpleMBeanThroughInheritance() throws Exception {
        ...
        Abc abc = new Abc();
        assertTrue(
                "Simple MBean (through inheritance) not detected correctly",
    ...
    public void testAppendIdentityToObjectName() throws MalformedObjectNameException {
        ...
        assertEquals(
                "Domain of transformed name is incorrect",
                objectName.getDomain(),
                uniqueName.getDomain());
        assertEquals(
                "Type key is incorrect",
                objectName.getKeyProperty(typeProperty),
                uniqueName.getKeyProperty("type"));
        assertEquals(
                "Identity key is incorrect",
