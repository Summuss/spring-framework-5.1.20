...
public abstract class AbstractMetadataAssemblerTests extends AbstractJmxAssemblerTests {
    ...
    public void testAttributeDescriptionOnSetter() throws Exception {
        ...
        assertEquals(
                "The description for the age attribute is incorrect",
                "The Age Attribute",
                attr.getDescription());
    }
    ...
    public void testAttributeDescriptionOnGetter() throws Exception {
        ...
        assertEquals(
                "The description for the name attribute is incorrect",
                "The Name Attribute",
                attr.getDescription());
    }
    ...
    public void testManagedResourceDescriptor() throws Exception {
        ...
        assertEquals(
                "Currency Time Limit should be 15", "15", desc.getFieldValue("currencyTimeLimit"));
        assertEquals(
                "Persist Policy should be OnUpdate",
                "OnUpdate",
                desc.getFieldValue("persistPolicy"));
        assertEquals("Persist Period should be 200", "200", desc.getFieldValue("persistPeriod"));
        assertEquals(
                "Persist Location should be foo", "./foo", desc.getFieldValue("persistLocation"));
    ...
    public void testAttributeDescriptor() throws Exception {
        ...
        assertEquals(
                "Currency Time Limit should be 20", "20", desc.getFieldValue("currencyTimeLimit"));
        assertEquals(
                "Persist Policy should be OnUpdate",
                "OnUpdate",
                desc.getFieldValue("persistPolicy"));
    ...
    public void testOperationDescriptor() throws Exception {
        ...
        assertEquals(
                "Currency Time Limit should be 30", "30", desc.getFieldValue("currencyTimeLimit"));
    ...
    public void testWithCglibProxy() throws Exception {
        ...
        assertTrue(
                "Not included in autodetection",
                assembler.includeBean(proxy.getClass(), "some bean name"));
    }
    ...
    public void testMetricDescription() throws Exception {
        ...
        assertEquals(
                "The description for the queue size metric is incorrect",
                "The QueueSize metric",
    ...
    public void testMetricDescriptorDefaults() throws Exception {
        ...
        assertNull(
                "Currency Time Limit should not be populated",
                desc.getFieldValue("currencyTimeLimit"));
        ...
        assertEquals(
                "Display Name should be populated by default via JMX",
                CACHE_ENTRIES_METRIC,
                desc.getFieldValue("displayName"));
