...
public class NotificationPublisherTests extends AbstractMBeanServerTests {
    ...
    public void testSimpleBean() throws Exception {
        ...
        assertNotNull(
                "NotificationPublisher should not be null", publisher.getNotificationPublisher());
    ...
    */
    ...
    public void testLazyInit() throws Exception {
        ...
        assertFalse(
                "Should not have instantiated the bean yet",
                ctx.getBeanFactory().containsSingleton("publisher"));
