...
public class JndiObjectFactoryBean extends JndiObjectLocator
     ...
     *
     * <p>Typically used in conjunction with "lookupOnStartup"=false and/or "cache"=false. Needs to
     * be specified because the actual JNDI object type is not known in advance in case of a lazy
     * lookup.
     *
     ...
     *
     * <p>Can be turned off to allow for late availability of the JNDI object. In this case, the
     * JNDI object will be fetched on first access.
     *
     ...
     * for each method invocation, as needed by WebLogic for JNDI-obtained factories (e.g. JDBC
     ...
     * values in scenarios where the JNDI environment might define specific config settings but
     * those are not required to be present.
     *
    ...
    public void afterPropertiesSet() throws IllegalArgumentException, NamingException {
        ...
        if (this.proxyInterfaces != null
            ...
            if (this.defaultObject != null
                ...
                try {
                    this.defaultObject =
                            converter.convertIfNecessary(this.defaultObject, getExpectedType());
        ...
        try {
            ...
            if (this.defaultObject != null) {
                if (logger.isTraceEnabled()) {
                    ...
                    logger.debug(
                            "JNDI lookup failed - returning specified default object instead: "
                                    + ex);
                }
    ...
    private static class JndiObjectProxyFactory {
        ...
        private static Object createJndiObjectProxy(JndiObjectFactoryBean jof)
            ...
            if (jof.proxyInterfaces != null) {
                ...
                Class<?>[] ifcs =
                        ClassUtils.getAllInterfacesForClass(targetClass, jof.beanClassLoader);
                for (Class<?> ifc : ifcs) {
    ...
    private static class JndiContextExposingInterceptor implements MethodInterceptor {
        ...
        public Object invoke(MethodInvocation invocation) throws Throwable {
            Context ctx =
                    (isEligible(invocation.getMethod()) ? this.jndiTemplate.getContext() : null);
            try {
