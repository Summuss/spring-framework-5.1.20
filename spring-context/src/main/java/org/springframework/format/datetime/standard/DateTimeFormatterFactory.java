...
public class DateTimeFormatterFactory {
     ...
     *
     * <p>The first character is used for the date style; the second is for the time style.
     ...
     *
     * <p>If no specific pattern or style has been defined, {@link FormatStyle#MEDIUM medium date
    ...
    public DateTimeFormatter createDateTimeFormatter(DateTimeFormatter fallbackFormatter) {
        ...
        if (StringUtils.hasLength(this.pattern)) {
            ...
            dateTimeFormatter =
                    DateTimeFormatter.ofPattern(patternToUse)
            ...
            dateTimeFormatter =
                    DateTimeFormatter.ofLocalizedDateTime(this.dateStyle, this.timeStyle);
