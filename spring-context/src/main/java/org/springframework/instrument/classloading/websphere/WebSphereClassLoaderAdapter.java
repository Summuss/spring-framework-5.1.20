...
class WebSphereClassLoaderAdapter {
    ...
    public WebSphereClassLoaderAdapter(ClassLoader classLoader) {
        ...
        try {
            ...
            this.addPreDefinePlugin =
                    classLoader
                            .getClass()
                            .getMethod("addPreDefinePlugin", this.wsPreProcessorClass);
    ...
    public void addTransformer(ClassFileTransformer transformer) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Could not invoke WebSphere addPreDefinePlugin method", ex);
        }
    }
    ...
    public ClassLoader getThrowawayClassLoader() {
        try {
            ...
            throw new IllegalStateException(
                    "Could not construct WebSphere CompoundClassLoader", ex);
        }
    }
}
