...
public class ModelMBeanNotificationPublisher implements NotificationPublisher {
    ...
    public ModelMBeanNotificationPublisher(
            ModelMBeanNotificationBroadcaster modelMBean,
    ...
    public void sendNotification(Notification notification) {
        ...
        try {
            if (notification instanceof AttributeChangeNotification) {
                this.modelMBean.sendAttributeChangeNotification(
    ...
    /**
     * Replaces the notification source if necessary to do so. From the {@link Notification
     * javadoc}: <i>"It is strongly recommended that notification senders use the object name rather
     * than a reference to the MBean object as the source."</i>
     *
