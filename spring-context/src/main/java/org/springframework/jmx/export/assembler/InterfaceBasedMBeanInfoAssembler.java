...
public class InterfaceBasedMBeanInfoAssembler extends AbstractConfigurableMBeanInfoAssembler
    ...
    /**
     * Check to see if the {@code Method} is declared in one of the configured interfaces and that
     * it is public.
     *
     ...
     * @return {@code true} if the {@code Method} is declared in one of the configured interfaces
     *     and is public, otherwise {@code false}.
     */
        ...
        for (Class<?> ifc : ifaces) {
            for (Method ifcMethod : ifc.getMethods()) {
                if (ifcMethod.getName().equals(method.getName())
                        ...
                        && Arrays.equals(
                                ifcMethod.getParameterTypes(), method.getParameterTypes())) {
                    return true;
                }
            }
        }
