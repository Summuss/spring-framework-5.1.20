...
public abstract class ValidationUtils {
     ...
     *     arguments is {@code null}, or if the supplied {@code Validator} does not {@link
     ...
     * Errors} instance can resolve field values by itself (it will usually hold an internal
