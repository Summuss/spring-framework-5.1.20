...
public class DefaultBindingErrorProcessor implements BindingErrorProcessor {
    ...
    /**
     * Error code that a missing field error (i.e. a required field not found in the list of
     * property values) will be registered with: "required".
     */
        ...
        if (ObjectUtils.isArray(rejectedValue)) {
            rejectedValue =
                    StringUtils.arrayToCommaDelimitedString(
                            ObjectUtils.toObjectArray(rejectedValue));
        }
        FieldError error =
                new FieldError(
                        bindingResult.getObjectName(),
