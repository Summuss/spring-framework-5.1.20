...
public interface ApplicationContext
     ...
     *
     * <p>This is not typically used by application code, except for the purpose of initializing
     * bean instances that live outside of the application context, applying the Spring bean
     * lifecycle (fully or partly) to them.
     *
     ...
     * application context has been closed.</b> In current Spring Framework versions, only
