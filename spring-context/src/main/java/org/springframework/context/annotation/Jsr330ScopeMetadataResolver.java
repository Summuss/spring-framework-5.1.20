...
public class Jsr330ScopeMetadataResolver implements ScopeMetadataResolver {
    ...
    /**
     * Register an extended JSR-330 scope annotation, mapping it onto a specific Spring scope by
     * name.
     *
        ...
        if (definition instanceof AnnotatedBeanDefinition) {
            ...
            for (String annType : annTypes) {
                ...
                if (metaAnns.contains("javax.inject.Scope")) {
                    ...
                    if (scopeName == null) {
                        throw new IllegalStateException(
                                "Unsupported scope annotation - not mapped onto Spring scope name: "
                                        + annType);
                    }
