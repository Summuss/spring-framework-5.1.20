...
public class AnnotatedBeanDefinitionReader {
    ...
    public <T> void registerBean(
            Class<T> beanClass, String name, @Nullable Supplier<T> instanceSupplier) {
     ...
     * @param definitionCustomizers one or more callbacks for customizing the factory's {@link
