...
public class MessageSourceResourceBundle extends ResourceBundle {
    ...
    /**
     * This implementation resolves the code in the MessageSource. Returns {@code null} if the
    ...
    /**
     * This implementation checks whether the target MessageSource can resolve a message for the
     * given key, translating {@code NoSuchMessageException} accordingly. In contrast to
     * ResourceBundle's default implementation in JDK 1.6, this does not rely on the capability to
     * enumerate message keys.
     */
    @Override
     ...
     * {@code ResourceBundle.getLocale()} method.
     */
    @Override
