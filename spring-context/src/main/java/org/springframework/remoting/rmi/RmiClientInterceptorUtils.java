...
public abstract class RmiClientInterceptorUtils {
    ...
    public static Object invokeRemoteMethod(MethodInvocation invocation, Object stub)
        ...
        try {
            if (method.getDeclaringClass().isInstance(stub)) {
                ...
                Method stubMethod =
                        stub.getClass().getMethod(method.getName(), method.getParameterTypes());
            ...
            throw new RemoteProxyFailureException(
                    "Invocation of RMI stub method failed: " + method, ex);
        }
    }
     ...
     * RemoteException).
     *
     * <p>Only call this for remote access exceptions, not for exceptions thrown by the target
     * service itself!
     *
