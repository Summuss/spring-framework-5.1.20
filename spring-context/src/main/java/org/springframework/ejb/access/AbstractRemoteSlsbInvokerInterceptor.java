...
public abstract class AbstractRemoteSlsbInvokerInterceptor extends AbstractSlsbInvokerInterceptor {
     ...
     *
     * <p>Can be turned on to allow for hot restart of the EJB server. If a cached EJB home throws
     * an RMI exception that indicates a remote connect failure, a fresh home will be fetched and
