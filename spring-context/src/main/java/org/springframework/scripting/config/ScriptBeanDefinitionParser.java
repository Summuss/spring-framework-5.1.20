...
class ScriptBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    /**
     * Parses the dynamic object element and returns the resulting bean definition. Registers a
     * {@link ScriptFactoryPostProcessor} if needed.
     */
    @Override
    ...
    private String resolveScriptSource(Element element, XmlReaderContext readerContext) {
        ...
        if (hasScriptSource && !elements.isEmpty()) {
            readerContext.error(
                    "Only one of 'script-source' and 'inline-script' should be specified.",
                    element);
            return null;
