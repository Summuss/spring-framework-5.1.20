...
public class StandardScriptFactory implements ScriptFactory, BeanClassLoaderAware {
    ...
    public Object getScriptedObject(
        ...
        if (script instanceof Class) {
            ...
            try {
                ...
                throw new ScriptCompilationException(
                        scriptSource,
                        "Unable to instantiate script class: " + scriptClass.getName(),
                        ex);
            } catch (IllegalAccessException ex) {
                throw new ScriptCompilationException(
                        scriptSource,
                        "Could not access script constructor: " + scriptClass.getName(),
                        ex);
            ...
            if (scriptEngine == null) {
                ...
                if (scriptEngine == null) {
                    throw new IllegalStateException(
                            "Could not determine script engine for " + scriptSource);
                }
    ...
    protected ScriptEngine retrieveScriptEngine(ScriptSource scriptSource) {
        ...
        if (this.scriptEngineName != null) {
            return StandardScriptUtils.retrieveEngineByName(
                    scriptEngineManager, this.scriptEngineName);
        }
    ...
    protected Object adaptToInterfaces(
        ...
        if (actualInterfaces.length == 1) {
            ...
            adaptedIfc =
                    ClassUtils.createCompositeInterface(actualInterfaces, this.beanClassLoader);
        }
