...
public class StandardScriptEvaluator implements ScriptEvaluator, BeanClassLoaderAware {
     ...
     * yet) providing common abbreviations for certain languages beyond what the JSR-223 script
     * engine factory exposes.
     *
     * @see #setEngineName
     */
    ...
    /**
     * Set the name of the script engine for evaluating the scripts (e.g. "Groovy"), as exposed by
     * the JSR-223 script engine factory.
     *
     * @since 4.2.2
     * @see #setLanguage
     */
    ...
    public Object evaluate(ScriptSource script, @Nullable Map<String, Object> argumentBindings) {
        ...
        try {
            ...
            throw new ScriptCompilationException(
                    script, "Cannot access script for ScriptEngine", ex);
        ...
        if (StringUtils.hasText(this.engineName)) {
            ...
            if (extension == null) {
                throw new IllegalStateException(
                        "No script language defined, and no file extension defined for resource: "
                                + resource);
            }
            ...
            throw new IllegalStateException(
                    "No script language defined, and no resource associated with script: "
                            + script);
        }
    }
}
