...
public class WebMvcStompWebSocketEndpointRegistrationTests {
    ...
    public void minimalRegistration() {
        ...
        assertEquals(
                1,
                ((WebSocketHttpRequestHandler) entry.getKey()).getHandshakeInterceptors().size());
    ...
    public void allowedOrigins() {
        ...
        assertEquals(
                ...
                wsHandler.getHandshakeInterceptors().get(0).getClass());
    }
    ...
    public void handshakeHandlerAndInterceptor() {
        ...
        assertEquals(
                OriginHandshakeInterceptor.class,
                requestHandler.getHandshakeInterceptors().get(1).getClass());
    }
