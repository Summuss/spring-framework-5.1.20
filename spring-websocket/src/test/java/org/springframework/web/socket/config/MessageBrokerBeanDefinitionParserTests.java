...
public class MessageBrokerBeanDefinitionParserTests {
    ...
    public void simpleBroker() throws Exception {
        ...
        assertThat(
                interceptors,
                contains(
                        instanceOf(FooTestInterceptor.class),
                        instanceOf(BarTestInterceptor.class),
                        instanceOf(OriginHandshakeInterceptor.class)));
        ...
        assertThat(
                wsTransportHandler.getHandshakeHandler(),
                Matchers.instanceOf(TestHandshakeHandler.class));
        ...
        assertNotNull(
                this.appContext.getBean("webSocketScopeConfigurer", CustomScopeConfigurer.class));
    ...
    public void stompBrokerRelay() {
        ...
        assertThat(
                messageBroker.getDestinationPrefixes(),
                Matchers.containsInAnyOrder("/topic", "/queue"));
    ...
    private void testChannel(
        ...
        assertEquals(
                ImmutableMessageChannelInterceptor.class,
                interceptors.get(interceptors.size() - 1).getClass());
    }
