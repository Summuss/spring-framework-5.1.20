...
public final class BinaryMessage extends AbstractWebSocketMessage<ByteBuffer> {
     ...
     *
     * @param payload a non-null payload; note that this value is not copied so care must be taken
     *     not to modify the array.
     */
     ...
     * message is sent as partial content and more partial messages will be expected until the
     * boolean flag is set to {@code true}.
     *
     * @param payload a non-null payload; note that this value is not copied so care must be taken
     *     not to modify the array.
     * @param isLast if the message is the last of a series of partial messages
