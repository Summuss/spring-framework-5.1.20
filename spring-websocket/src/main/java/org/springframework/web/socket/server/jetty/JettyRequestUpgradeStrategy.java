...
public class JettyRequestUpgradeStrategy
    ...
    @Nullable private WebSocketPolicy policy;

    @Nullable private volatile WebSocketServerFactory factory;

    @Nullable private ServletContext servletContext;

    private volatile boolean running = false;

    @Nullable private volatile List<WebSocketExtension> supportedExtensions;
            ...
            if (factory != null) {
                try {
                    ...
                    throw new IllegalStateException(
                            "Unable to stop Jetty WebSocketServerFactory", ex);
                }
            }
        }
    }
    ...
    private Set<String> getExtensionNames() {
        ...
        try {
            ...
            Set<String> result =
                    (Set<String>)
                            ReflectionUtils.invokeMethod(method, factory.getExtensionFactory());
    ...
    public void upgrade(
        ...
        Assert.state(factory != null, "No WebSocketServerFactory available");
        Assert.isTrue(
                factory.isUpgradeRequest(servletRequest, servletResponse),
    ...
    private static class WebSocketHandlerContainer {
        ...
        @Nullable private final String selectedProtocol;
        ...
        public WebSocketHandlerContainer(
            ...
            if (CollectionUtils.isEmpty(extensions)) {
                ...
                for (WebSocketExtension extension : extensions) {
                    this.extensionConfigs.add(
                            new WebSocketToJettyExtensionConfigAdapter(extension));
                }
            }
        }
