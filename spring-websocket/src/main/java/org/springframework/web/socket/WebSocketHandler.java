...
public interface WebSocketHandler {
    ...
    /**
     * Whether the WebSocketHandler handles partial messages. If this flag is set to {@code true}
     * and the underlying WebSocket server supports partial messages, then a large WebSocket
     * message, or one of an unknown size may be split and maybe received over multiple calls to
     * {@link #handleMessage(WebSocketSession, WebSocketMessage)}. The flag {@link
