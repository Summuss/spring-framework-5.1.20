...
public class MailSendException extends MailException {
    ...
    /**
     * Constructor for registration of failed messages, with the messages that failed as keys, and
     * the thrown exceptions as values.
     *
     ...
     *
     * <p>Note that a general mail server connection failure will not result in failed messages
     * being returned here: A message will only be contained here if actually sending it was
    ...
    public String toString() {
        if (ObjectUtils.isEmpty(this.messageExceptions)) {
            ...
            sb.append("; message exceptions (")
                    .append(this.messageExceptions.length)
                    .append(") are:");
            for (int i = 0; i < this.messageExceptions.length; i++) {
                Exception subEx = this.messageExceptions[i];
