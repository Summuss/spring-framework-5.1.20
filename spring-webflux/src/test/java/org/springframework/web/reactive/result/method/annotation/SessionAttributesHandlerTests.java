...
public class SessionAttributesHandlerTests {
    ...
    public void isSessionAttribute() {
        ...
        assertTrue(
                this.sessionAttributesHandler.isHandlerSessionAttribute("simple", TestBean.class));
        assertFalse(
                this.sessionAttributesHandler.isHandlerSessionAttribute("simple", String.class));
    }
    ...
    public void retrieveAttributes() {
        ...
        assertEquals(
                "Named attributes (attr1, attr2) should be 'known' right away",
