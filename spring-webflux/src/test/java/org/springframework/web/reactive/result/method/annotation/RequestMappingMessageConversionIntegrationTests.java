...
public class RequestMappingMessageConversionIntegrationTests
    ...
    public void byteBufferResponseBodyWithFlux() throws Exception {
        ...
        assertEquals(
                expected,
                performGet("/raw-response/flux", new HttpHeaders(), String.class).getBody());
    }
    ...
    public void byteBufferResponseBodyWithObservable() throws Exception {
        ...
        assertEquals(
                expected,
                performGet("/raw-response/observable", new HttpHeaders(), String.class).getBody());
    }
    ...
    public void byteBufferResponseBodyWithFlowable() throws Exception {
        ...
        assertEquals(
                expected,
                performGet("/raw-response/flowable", new HttpHeaders(), String.class).getBody());
    }
    ...
    public void personResponseBodyWithObservable() throws Exception {
        List<?> expected = asList(new Person("Robert"), new Person("Marie"));
        assertEquals(
                expected, performGet("/person-response/observable", JSON, PERSON_LIST).getBody());
    }
    ...
    public void personTransformWithPublisher() throws Exception {
        ...
        assertEquals(
                res,
                performPost("/person-transform/publisher", JSON, req, JSON, PERSON_LIST).getBody());
    }
    ...
    public void personTransformWithFlux() throws Exception {
        ...
        List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
        assertEquals(
                res, performPost("/person-transform/flux", JSON, req, JSON, PERSON_LIST).getBody());
    }
    ...
    public void personTransformWithFlowable() throws Exception {
        ...
        assertEquals(
                res,
                performPost("/person-transform/flowable", JSON, req, JSON, PERSON_LIST).getBody());
    }
    ...
    public void personCreateWithPublisherJson() throws Exception {
        ...
        assertEquals(
                2, getApplicationContext().getBean(PersonCreateController.class).persons.size());
    }
    ...
    public void personCreateWithMono() throws Exception {
        ...
        assertEquals(HttpStatus.OK, entity.getStatusCode());
        assertEquals(
                1, getApplicationContext().getBean(PersonCreateController.class).persons.size());
    }
