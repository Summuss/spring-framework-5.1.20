...
public class BindStatus {
    ...
    /**
     * Return a bind expression that can be used in HTML forms as input name for the respective
     * field, or {@code null} if not field-specific.
     *
    ...
    /**
     * Return the current value of the field, i.e. either the property value or a rejected update,
    ...
    /**
     * Return the error codes for the field or object, if any. Returns an empty array instead of
     * null if none.
     */
