...
public interface ServerResponse {
    ...
    interface HeadersBuilder<B extends HeadersBuilder<B>> {
         ...
         * {@code voidPublisher} completes.
         *
         * @param voidPublisher publisher publisher to indicate when the response should be
         *     committed
         */
    ...
    interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
         ...
         * This convenience method combines {@link #body(BodyInserter)} and {@link
        ...
        /**
         * Set the body of the response to the given synchronous {@code Object} and return it. This
         * convenience method combines {@link #body(BodyInserter)} and {@link
         * BodyInserters#fromObject(Object)}.
         *
         * @param body the body of the response
         * @return the built response
         * @throws IllegalArgumentException if {@code body} is a {@link Publisher}, for which {@link
         *     #body(Publisher, Class)} should be used.
         */
