 ...
 * accessible in the application context. Alternatively set the FreeMarker configuration can be set
 * directly on this class via {@link #setConfiguration}.
 *
...
public class FreeMarkerView extends AbstractUrlBasedView {
     ...
     * configuration to "UTF-8". It's recommended to specify the encoding in the FreeMarker
