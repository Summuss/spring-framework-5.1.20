...
public abstract class BodyInserters {
     ...
     *
     * <p>Alternatively, consider using the {@code syncBody(Object)} shortcuts on {@link
    ...
    public static <T> BodyInserter<T, ReactiveHttpOutputMessage> fromObject(T body) {
        return (message, context) ->
                writeWithMessageWriters(
                        message, context, Mono.just(body), ResolvableType.forInstance(body));
    }
    ...
    public static <T, P extends Publisher<T>>
        ...
        return (message, context) ->
                writeWithMessageWriters(
                        message, context, publisher, ResolvableType.forClass(elementClass));
    }
     ...
     * Class)}, and set the "Content-Type" to {@link MediaType#TEXT_EVENT_STREAM text/event-stream}.
     *
     ...
     *
     * <p>Note that you can also use the {@code syncBody(Object)} method in the request builders of
     ...
     * MultipartBodyBuilder}, and pass the resulting map directly to the {@code syncBody(Object)}
    ...
    private static <P extends Publisher<?>, M extends ReactiveHttpOutputMessage>
            Mono<Void> writeWithMessageWriters(
                    M outputMessage,
