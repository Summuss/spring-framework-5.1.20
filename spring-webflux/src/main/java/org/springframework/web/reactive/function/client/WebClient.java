...
public interface WebClient {
    ...
    interface Builder {
         ...
         * and effectively overrides the following:
         *
         * <ul>
    ...
    interface UriSpec<S extends RequestHeadersSpec<?>> {
        ...
        /**
         * Build the URI for the request using the {@link UriBuilderFactory} configured for this
         * client.
         */
    ...
    interface RequestBodySpec extends RequestHeadersSpec<RequestBodySpec> {
        ...
        /**
         * Set the body of the request using the given body inserter. {@link BodyInserters} provides
         * access to built-in implementations of {@link BodyInserter}.
         *
        ...
        /**
         * A shortcut for {@link #body(BodyInserter)} with a {@linkplain BodyInserters#fromPublisher
        ...
        /**
         * A variant of {@link #body(Publisher, Class)} that allows providing element type
         * information that includes generics via a {@link ParameterizedTypeReference}.
         *
         * @param publisher the {@code Publisher} to write to the request
        ...
        /**
         * A shortcut for {@link #body(BodyInserter)} with an {@linkplain BodyInserters#fromObject
         * Object inserter}. For example:
         *
         * <p>
         *
         * <pre class="code">
         ...
         * </pre>
         *
         * <p>For multipart requests, provide a {@link org.springframework.util.MultiValueMap
         * MultiValueMap}. The values in the {@code MultiValueMap} can be any Object representing
         * the body of the part, or an {@link org.springframework.http.HttpEntity HttpEntity}
         * representing a part with body and headers. The {@code MultiValueMap} can be built with
    ...
    interface ResponseSpec {
         ...
         * predicate applies. The exception returned from the function will be returned from {@link
         ...
         *     exceptionFunction should consume it. If not, the content will be automatically
         *     drained to ensure resources are released.
         ...
         * WebClientResponseException} when the response status code is 4xx or 5xx.
         *
         * @param statusCodePredicate a predicate of the raw status code that indicates whether
         *     {@code exceptionFunction} applies.
         *     <p><strong>NOTE:</strong> if the response is expected to have content, the
         *     exceptionFunction should consume it. If not, the content will be automatically
         *     drained to ensure resources are released.
         * @param exceptionFunction the function that returns the exception
