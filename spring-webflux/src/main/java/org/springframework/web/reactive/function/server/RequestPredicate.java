...
public interface RequestPredicate {
     ...
     * match.
     *
     * <p>The default implementation returns an {@code Optional} wrapping the given path if {@link
     * #test(ServerRequest)} evaluates to {@code true}; or {@link Optional#empty()} if it evaluates
     * to {@code false}.
     *
