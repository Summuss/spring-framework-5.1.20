...
public final class PatternsRequestCondition
     ...
     * equivalent to those of calling {@link #getMatchingCondition(ServerWebExchange)}. This method
     * is provided as an alternative to be used if no request is available (e.g. introspection,
     * tooling, etc).
     *
     * @param exchange the current exchange
