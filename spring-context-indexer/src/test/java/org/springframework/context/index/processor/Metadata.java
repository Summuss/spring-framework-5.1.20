...
public class Metadata {
    ...
    private static class ItemMetadataMatcher extends BaseMatcher<CandidateComponentsMetadata> {
        ...
        public ItemMetadataMatcher(String type, Class<?>... stereotypes) {
            this(type, Arrays.stream(stereotypes).map(Class::getName).collect(Collectors.toList()));
        }
        ...
        public boolean matches(Object value) {
            ...
            ItemMetadata itemMetadata =
                    getFirstItemWithType((CandidateComponentsMetadata) value, this.type);
        ...
        private ItemMetadata getFirstItemWithType(
                CandidateComponentsMetadata metadata, String type) {
