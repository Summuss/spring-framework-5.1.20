...
/**
 * Implementation of the {@code Marshaller} interface for Castor. By default, Castor does not
 * require any further configuration, though setting target classes, target packages or providing a
 * mapping file can be used to have more control over the behavior of Castor.
 *
 * <p>If a target class is specified using {@code setTargetClass}, the {@code CastorMarshaller} can
 * only be used to unmarshal XML that represents that specific class. If you want to unmarshal
 * multiple classes, you have to provide a mapping file using {@code setMappingLocations}.
 *
 * <p>Due to limitations of Castor's API, it is required to set the encoding used for writing to
 * output streams. It defaults to {@code UTF-8}.
 *
...
public class CastorMarshaller extends AbstractMarshaller
    ...
    @Nullable private Class<?>[] targetClasses;

    @Nullable private String[] targetPackages;
    ...
    @Nullable private String rootElement;
    ...
    @Nullable private Object rootObject;

    private boolean reuseObjects = false;

    private boolean clearCollections = false;

    @Nullable private Map<String, String> castorProperties;

    @Nullable private Map<String, String> doctypes;

    @Nullable private Map<String, String> processingInstructions;

    @Nullable private Map<String, String> namespaceMappings;

    @Nullable private Map<String, String> namespaceToPackageMapping;

    @Nullable private EntityResolver entityResolver;

    @Nullable private XMLClassDescriptorResolver classDescriptorResolver;

    @Nullable private IDResolver idResolver;

    @Nullable private ObjectFactory objectFactory;

    @Nullable private ClassLoader beanClassLoader;

    @Nullable private XMLContext xmlContext;
    ...
    /**
     * Set the value of {@code xsi:noNamespaceSchemaLocation} attribute. When set, the {@code
    ...
    /**
     * Set the value of {@code xsi:schemaLocation} attribute. When set, the {@code
     * xsi:schemaLocation} attribute will be written for the root element.
     *
    ...
    /**
     * Sets whether this marshaller should output the {@code xsi:type} attribute for the root
     * element. This can be useful when the type of the element can not be simply determined from
     * the element name.
     *
     * <p>The default is {@code false}: The {@code xsi:type} attribute for the root element won't be
     * written.
     *
    ...
    /**
     * Set whether the Castor {@link Unmarshaller} should ignore attributes that do not match a
     * specific field.
     *
    ...
    /**
     * Set whether the Castor {@link Unmarshaller} should ignore elements that do not match a
     * specific field.
     *
    ...
    /**
     * Set the expected root object for the unmarshaller, into which the source will be
     * unmarshalled.
     *
    ...
    /**
     * Set whether this unmarshaller should re-use objects. This will be only used when
    ...
    /**
     * Set Castor-specific properties for marshalling and unmarshalling. Each entry key is
     * considered the property name and each value the property value.
     *
    ...
    /**
     * Set the map containing document type definition for the marshaller. Each entry has system id
     * as key and public id as value.
     *
    ...
    /**
     * Sets the processing instructions that will be used by during marshalling. Keys are the
     * processing targets and values contain the processing data.
     *
    ...
    /**
     * Set the namespace mappings. Property names are interpreted as namespace prefixes; values are
     * namespace URIs.
     *
    ...
    /**
     * Set the namespace to package mappings. Property names are represents the namespaces URI,
     * values are packages.
     *
     * @see org.exolab.castor.xml.Marshaller#setNamespaceMapping(String, String)
     */
    ...
    /**
     * Set the {@link EntityResolver} to be used during unmarshalling. This resolver will used to
     * resolve system and public ids.
     *
    ...
    /**
     * Set the {@link XMLClassDescriptorResolver} to be used during unmarshalling. This resolver
     * will used to resolve class descriptors.
     *
    ...
    public void afterPropertiesSet() throws CastorMappingException, IOException {
        try {
            this.xmlContext =
                    createXMLContext(
                            this.mappingLocations, this.targetClasses, this.targetPackages);
    ...
    /**
     * Create the Castor {@code XMLContext}. Subclasses can override this to create a custom
     * context.
     *
     * <p>The default implementation loads mapping files if defined, or the target class or packages
     * if defined.
     *
     ...
     */
    protected XMLContext createXMLContext(
            @Nullable Resource[] mappingLocations,
            @Nullable Class<?>[] targetClasses,
            @Nullable String[] targetPackages)
    ...
    /**
     * Convert the given {@code XMLException} to an appropriate exception from the {@code
