...
public class CastorMarshallerTests extends AbstractMarshallerTests<CastorMarshaller> {
    ...
    private static final String XSI_EXPECTED_STRING =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
    ...
    protected CastorMarshaller createMarshaller() throws Exception {
        ...
        ClassPathResource mappingLocation =
                new ClassPathResource("mapping.xml", CastorMarshaller.class);
    ...
    public void marshalSaxResult() throws Exception {
        ...
        ordered.verify(contentHandler)
                .startPrefixMapping("tns", "http://samples.springframework.org/flight");
        ordered.verify(contentHandler)
                .startElement(
        ...
        ordered.verify(contentHandler)
                .endElement("http://samples.springframework.org/flight", "number", "tns:number");
        ordered.verify(contentHandler)
                .endElement("http://samples.springframework.org/flight", "flight", "tns:flight");
        ordered.verify(contentHandler)
                .endElement("http://samples.springframework.org/flight", "flights", "tns:flights");
    ...
    public void suppressNamespacesTrue() throws Exception {
        ...
        assertThat(
                "Marshaller wrote invalid result",
                result,
                isSimilarTo(SUPPRESSED_NAMESPACE_EXPECTED_STRING));
    }
    ...
    public void suppressXsiTypeTrue() throws Exception {
        ...
        assertThat(
                "Marshaller wrote invalid result",
                result,
                isSimilarTo(SUPPRESSED_XSI_EXPECTED_STRING));
    }
    ...
    public void marshalAsDocumentTrue() throws Exception {
        ...
        String result = marshalFlights();
        assertThat(
                "Marshaller wrote invalid result", result, isSimilarTo(DOCUMENT_EXPECTED_STRING));
        assertTrue(
                "Result doesn't contain xml declaration.",
    ...
    public void rootElement() throws Exception {
        ...
        assertThat(
                "Marshaller wrote invalid result",
                result,
                isSimilarTo(ROOT_ELEMENT_EXPECTED_STRING));
    }
    ...
    public void noNamespaceSchemaLocation() throws Exception {
        ...
        assertXpathEvaluatesTo(
                ...
                "/tns:flights/@xsi:noNamespaceSchemaLocation",
                result);
        assertThat("Marshaller wrote invalid result", result, isSimilarTo(EXPECTED_STRING));
    }
    ...
    public void schemaLocation() throws Exception {
        ...
        assertXpathEvaluatesTo(
                "The xsi:noNamespaceSchemaLocation hasn't been written or has invalid value.",
                schemaLocation,
                "/tns:flights/@xsi:schemaLocation",
                result);
        assertThat("Marshaller wrote invalid result", result, isSimilarTo(EXPECTED_STRING));
    }
    ...
    public void useXsiTypeAsRootTrue() throws Exception {
        ...
        assertThat(
                "Marshaller wrote invalid result",
                result,
                isSimilarTo(ROOT_WITH_XSI_EXPECTED_STRING));
    }
    ...
    public void useXsiTypeAsRootFalse() throws Exception {
        ...
        assertThat(
                "Marshaller wrote invalid result",
                result,
                isSimilarTo(ROOT_WITHOUT_XSI_EXPECTED_STRING));
    }
     ...
     *
     * <p>The xpath may contain the xml namespace prefixes, since namespaces from flight example are
     * being registered.
     *
