...
public class CastorUnmarshallerTests extends AbstractUnmarshallerTests<CastorMarshaller> {
    ...
    public void setBothTargetClassesAndMapping() throws IOException {
        CastorMarshaller unmarshaller = new CastorMarshaller();
        unmarshaller.setMappingLocation(
                new ClassPathResource("order-mapping.xml", CastorMarshaller.class));
    ...
    public void clearCollectionsTrue() throws Exception {
        ...
        assertSame("Result Flights is different object.", flights, result);
        assertEquals(
                "Result Flights has incorrect number of Flight.",
                1,
                ((Flights) result).getFlightCount());
        testFlights(result);
    }
    ...
    public void clearCollectionsFalse() throws Exception {
        ...
        assertSame("Result Flights is different object.", flights, result);
        assertEquals(
                "Result Flights has incorrect number of Flights.",
                3,
                ((Flights) result).getFlightCount());
    ...
    public void unmarshalStreamSourceWithXmlOptions() throws Exception {
        ...
        CastorMarshaller marshaller =
                new CastorMarshaller() {
                    ...
                    protected Object unmarshalSaxReader(
                            XMLReader xmlReader, InputSource inputSource) {
        ...
        assertEquals(
                true,
                result.get().getFeature("http://apache.org/xml/features/disallow-doctype-decl"));
        assertEquals(
                false,
