...
public class SettableListenableFuture<T> implements ListenableFuture<T> {
    ...
    /**
     * Set the exception of this future. This method will return {@code true} if the exception was
     ...
     * Retrieve the value.
     *
     * <p>This method returns the value if it has been set via {@link #set(Object)}, throws an
     * {@link java.util.concurrent.ExecutionException} if an exception has been set via {@link
