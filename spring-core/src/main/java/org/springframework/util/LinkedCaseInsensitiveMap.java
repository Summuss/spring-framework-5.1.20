...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
     ...
     * initial capacity and stores case-insensitive keys according to the default Locale (by default
     * in lower case).
     *
    ...
    /**
     * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with the given
     * initial capacity and stores case-insensitive keys according to the given Locale (by default
     * in lower case).
     *
     * @param initialCapacity the initial capacity
     * @param locale the Locale to use for case-insensitive key conversion
    ...
    /**
     * Return the locale used by this {@code LinkedCaseInsensitiveMap}. Used for case-insensitive
     * key conversion.
     *
     * @since 4.3.10
