...
public class SimpleNamespaceContext implements NamespaceContext {
    ...
    /**
     * Set the bindings for this namespace context. The supplied map must consist of string key
     * value pairs.
     */
    ...
    public void bindNamespaceUri(String prefix, String namespaceUri) {
        ...
        if (XMLConstants.DEFAULT_NS_PREFIX.equals(prefix)) {
            ...
            Set<String> prefixes =
                    this.namespaceUriToPrefixes.computeIfAbsent(
                            namespaceUri, k -> new LinkedHashSet<>());
            prefixes.add(prefix);
        }
    }
