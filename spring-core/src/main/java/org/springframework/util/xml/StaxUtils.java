...
public abstract class StaxUtils {
     ...
     *
     * @return {@code true} if {@code source} is a JAXP 1.4 {@link StAXSource} or custom StAX
     ...
     *
     * @return {@code true} if {@code result} is a JAXP 1.4 {@link StAXResult} or custom StAX
     ...
     * StAX {@code XMLInputFactory} allows one to create an event reader from a stream reader, but
     * not vice-versa.
     *
