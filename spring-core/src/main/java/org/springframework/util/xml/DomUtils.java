...
public abstract class DomUtils {
     ...
     * names. Only looks at the direct child level of the given element; do not go into further
     * depth (in contrast to the DOM API's {@code getElementsByTagName} method).
     *
     ...
     * look at the direct child level of the given element; do not go into further depth (in
     * contrast to the DOM API's {@code getElementsByTagName} method).
     *
     * @param ele the DOM element to analyze
    ...
    /**
     * Namespace-aware equals comparison. Returns {@code true} if either {@link Node#getLocalName}
     * or {@link Node#getNodeName} equals {@code desiredName}, otherwise returns {@code false}.
     */
