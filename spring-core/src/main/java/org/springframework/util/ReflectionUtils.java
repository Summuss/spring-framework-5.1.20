...
public abstract class ReflectionUtils {
    ...
    @Deprecated
    @Nullable
    public static Object invokeJdbcMethod(Method method, @Nullable Object target)
            throws SQLException {
    ...
    @Deprecated
    @Nullable
    public static Object invokeJdbcMethod(
    ...
    /**
     * This variant retrieves {@link Class#getDeclaredMethods()} from a local cache in order to
     * avoid the JVM's SecurityManager check and defensive array copying. In addition, it also
     * includes Java 8 default methods from locally implemented interfaces, since those are
