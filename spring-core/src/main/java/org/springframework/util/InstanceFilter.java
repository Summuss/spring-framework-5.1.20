...
public class InstanceFilter<T> {
     ...
     *
     * <p>A particular element will match if it "matches" the one of the element in the includes
     * list and does not match one of the element in the excludes list.
     *
     * <p>Subclasses may redefine what matching means. By default, an element match with another if
     * it is equals according to {@link Object#equals(Object)}
     *
