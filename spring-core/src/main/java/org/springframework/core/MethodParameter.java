...
public class MethodParameter {
     ...
     * nesting level deeper. This is effectively the same as {@link #increaseNestingLevel()}, just
     * with an independent {@code MethodParameter} object (e.g. in case of the original being
     * cached).
     *
     * @since 4.3
     */
    ...
    private static class KotlinDelegate {
        ...
        /**
         * Check whether the specified {@link MethodParameter} represents a nullable Kotlin type or
         * an optional parameter (with a default value in the Kotlin declaration).
         */
