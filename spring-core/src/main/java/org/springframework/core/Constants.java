...
public class Constants {
     ...
     * @throws ConstantException if the field name wasn't found or if the type wasn't compatible
     *     with Number
     * @see #asObject
     */
    ...
    /**
     * Parse the given String (upper or lower case accepted) and return the appropriate value if
     * it's the name of a constant field in the class that we're analysing.
     *
     * @param code the name of the field (never {@code null})
     ...
     *
     * <p>Note that this method assumes that constants are named in accordance with the standard
     * Java convention for constant values (i.e. all uppercase). The supplied {@code namePrefix}
     * will be uppercased (in a locale-insensitive fashion) prior to the main logic of this method
     * kicking in.
     *
    ...
    public Set<String> getNames(@Nullable String namePrefix) {
        String prefixToUse =
                (namePrefix != null ? namePrefix.trim().toUpperCase(Locale.ENGLISH) : "");
     ...
     *
     * <p>Note that this method assumes that constants are named in accordance with the standard
     * Java convention for constant values (i.e. all uppercase). The supplied {@code nameSuffix}
     * will be uppercased (in a locale-insensitive fashion) prior to the main logic of this method
     * kicking in.
     *
    ...
    public Set<String> getNamesForSuffix(@Nullable String nameSuffix) {
        String suffixToUse =
                (nameSuffix != null ? nameSuffix.trim().toUpperCase(Locale.ENGLISH) : "");
        Set<String> names = new HashSet<>();
        for (String code : this.fieldCache.keySet()) {
     ...
     *
     * <p>Uses a common naming idiom: turning all lower case characters to upper case, and
