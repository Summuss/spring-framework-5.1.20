...
public class ConfigurableObjectInputStream extends ObjectInputStream {
    ...
    protected Class<?> resolveProxyClass(String[] interfaces)
        ...
        if (this.classLoader != null) {
            ...
            try {
                ...
                return ClassUtils.createCompositeInterface(
                        resolvedInterfaces, getFallbackClassLoader());
            }
        }
    }
     ...
     *
     * <p>The default implementation simply returns {@code null}, indicating that no specific
