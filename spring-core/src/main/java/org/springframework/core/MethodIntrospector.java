...
public final class MethodIntrospector {
     ...
     *
     * <p>Callers define methods of interest through the {@link MetadataLookup} parameter, allowing
     * to collect the associated metadata into the result map.
     *
     ...
     * @return the selected methods associated with their metadata (in the order of retrieval), or
     *     an empty map in case of no match
     */
     ...
     * @param targetType the target type to search methods on (typically an interface-based JDK
     *     proxy)
    ...
    public interface MetadataLookup<T> {
         ...
         * @return non-null metadata to be associated with a method if there is a match, or {@code
         *     null} for no match
         */
        @Nullable
