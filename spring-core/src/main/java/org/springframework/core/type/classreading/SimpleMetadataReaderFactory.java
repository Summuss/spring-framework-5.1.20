...
public class SimpleMetadataReaderFactory implements MetadataReaderFactory {
    ...
    public MetadataReader getMetadataReader(String className) throws IOException {
        try {
            ...
            // Maybe an inner class name using the dot name syntax? Need to use the dollar syntax
            // here...
            // ClassUtils.forName has an equivalent check for resolution into Class references later
            // on.
            ...
            if (lastDotIndex != -1) {
                ...
                Resource innerClassResource =
                        this.resourceLoader.getResource(innerClassResourcePath);
