...
/**
 * Abstract base class for {@link AnnotationAttributeExtractor} implementations that transparently
 * enforce attribute alias semantics for annotation attributes that are annotated with {@link
 * AliasFor @AliasFor}.
 *
 * @author Sam Brannen
 * @since 4.2
...
abstract class AbstractAliasAwareAnnotationAttributeExtractor<S>
    ...
    @Nullable private final Object annotatedElement;
    ...
    public final Object getAttributeValue(Method attributeMethod) {
        ...
        if (aliasNames != null) {
            Object defaultValue =
                    AnnotationUtils.getDefaultValue(this.annotationType, attributeName);
                ...
                if (!ObjectUtils.nullSafeEquals(attributeValue, aliasValue)
                    ...
                    throw new AnnotationConfigurationException(
                            String.format(
                                    ...
                                    attributeName,
                                    aliasName,
                                    ObjectUtils.nullSafeToString(attributeValue),
                                    ObjectUtils.nullSafeToString(aliasValue)));
                }
    ...
    /**
     * Get the raw, unmodified attribute value from the underlying {@linkplain #getSource source}
    ...
    /**
     * Get the raw, unmodified attribute value from the underlying {@linkplain #getSource source}
     * that corresponds to the supplied attribute name.
     */
    @Nullable
