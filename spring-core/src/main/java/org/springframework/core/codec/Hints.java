...
public abstract class Hints {
    ...
    public static <T> T getRequiredHint(@Nullable Map<String, Object> hints, String hintName) {
        ...
        if (hint == null) {
            throw new IllegalArgumentException(
                    "Hints map must contain the hint '" + hintName + "'");
        }
        return hint;
    }
    ...
    /**
     * Merge two maps of hints, creating and copying into a new map if both have values, or
     * returning the non-empty map, or an empty map if both are empty.
     *
    ...
    public static Map<String, Object> merge(
            Map<String, Object> hints1, Map<String, Object> hints2) {
