...
public class ResourceRegion {
    ...
    /**
     * Create a new {@code ResourceRegion} from a given {@link Resource}. This region of a resource
     * is represented by a start {@code position} and a byte {@code count} within the given {@code
     * Resource}.
     *
