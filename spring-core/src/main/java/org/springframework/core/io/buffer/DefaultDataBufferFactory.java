...
public class DefaultDataBufferFactory implements DataBufferFactory {
     ...
     *
     * @param preferDirect {@code true} if direct buffers are to be preferred; {@code false}
     *     otherwise
     */
    ...
    /**
     * Creates a new {@code DefaultDataBufferFactory}, indicating whether direct buffers should be
     * created by {@link #allocateBuffer()} and {@link #allocateBuffer(int)}, and what the capacity
     * is to be used for {@link #allocateBuffer()}.
     *
     * @param preferDirect {@code true} if direct buffers are to be preferred; {@code false}
     *     otherwise
     */
    public DefaultDataBufferFactory(boolean preferDirect, int defaultInitialCapacity) {
        Assert.isTrue(
                defaultInitialCapacity > 0, "'defaultInitialCapacity' should be larger than 0");
     ...
     * {@inheritDoc}
     *
     * <p>This implementation creates a single {@link DefaultDataBuffer} to contain the data in
     * {@code dataBuffers}.
     */
    @Override
