...
public class Matchers {
    ...
    /**
     * Create a matcher that wrapps the specified matcher and tests against the {@link
     * Throwable#getCause() cause} of an exception. If the item tested is {@code null} not a {@link
     * Throwable} the wrapped matcher will be called with a {@code null} item.
     *
     * <p>Often useful when working with JUnit {@link ExpectedException} {@link Rule @Rule}s, for
     * example:
     *
     * <pre>
