...
/**
 * Provides utility methods that allow JUnit tests to {@link org.junit.Assume} certain conditions
 ...
 * </pre>
 *
 * <p>Groups can be specified as a comma separated list of values, or using the pseudo group 'all'.
...
public abstract class Assume {
    ...
    public static void group(TestGroup group) {
        ...
        if (!testGroups.contains(group)) {
            throw new AssumptionViolatedException(
                    "Requires unspecified group " + group + " from " + testGroups);
        }
    }

    /**
     * Assume that a particular {@link TestGroup} has been specified before executing the supplied
     * {@link Executable}.
     *
     * <p>If the assumption fails, the executable will not be executed, but no {@link
     * AssumptionViolatedException} will be thrown.
     *
     * @param group the group that must be specified
     ...
     * {@link NoClassDefFoundError} being thrown while attempting to load the {@code Assume} class.
     */
