...
public class StringUtilsTests {
    ...
    public void testDelete() {
        ...
        assertTrue(
                "Result has no dog", killEnd.equals("The quick brown fox jumped over the lazy "));
    ...
    public void testCleanPath() {
        ...
        assertEquals("file:../", StringUtils.cleanPath("file:.././"));
        assertEquals(
                "file:///c:/path/the%20file.txt",
                StringUtils.cleanPath("file:///c:/some/../path/the%20file.txt"));
    }
    ...
    public void testParseLocaleWithVariantContainingCountryCode() {
        ...
        Locale locale = StringUtils.parseLocaleString(localeString);
        assertEquals(
                "Variant containing country code not extracted correctly",
                variant,
                locale.getVariant());
    }
    ...
    public void testInvalidLocaleWithLocaleString() {
        ...
        assertEquals(
                new Locale("invalidvalue", "foo"),
                StringUtils.parseLocaleString("invalidvalue_foo"));
    ...
    public void testInvalidLocaleWithLanguageTag() {
        ...
        assertEquals(
                new Locale("invalidvalue", "foo"), StringUtils.parseLocale("invalidvalue_foo"));
