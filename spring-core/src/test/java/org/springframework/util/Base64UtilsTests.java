...
public class Base64UtilsTests {
    ...
    public void encodeToStringWithJdk8VsJaxb() throws UnsupportedEncodingException {
        ...
        assertArrayEquals(
                bytes,
                DatatypeConverter.parseBase64Binary(DatatypeConverter.printBase64Binary(bytes)));
    ...
    public void encodeDecodeUrlSafe() {
        ...
        assertArrayEquals(
                bytes,
                Base64Utils.decodeFromUrlSafeString(Base64Utils.encodeToUrlSafeString(bytes)));
    }
}
