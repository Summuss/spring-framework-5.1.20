...
public class AnnotationAttributesTests {
    ...
    public void typeSafeAttributeAccess() {
        ...
        assertThat(
                attributes.getStringArray("names"), equalTo(new String[] {"dave", "frank", "hal"}));
        ...
        assertThat(
                attributes.getClassArray("classes"),
        ...
        assertThat(
                attributes.getAnnotationArray("annoArray")[0].getString("name"),
                equalTo("algernon"));
    }
    ...
    public void getEnumWithTypeMismatch() {
        ...
        exception.expectMessage(
                containsString("Attribute 'color' is of type String, but Enum was expected"));
    ...
    public void getAliasedStringArrayWithImplicitAliases() {
        ...
        AnnotationUtils.postProcessAnnotationAttributes(null, attributes, false);
        aliases.stream()
                .forEach(alias -> assertArrayEquals(value, attributes.getStringArray(alias)));
        ...
        aliases.stream()
                .forEach(
                        alias ->
                                assertArrayEquals(
                                        new String[] {""}, attributes.getStringArray(alias)));
    }
