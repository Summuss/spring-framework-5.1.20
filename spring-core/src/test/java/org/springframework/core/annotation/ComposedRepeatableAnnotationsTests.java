...
public class ComposedRepeatableAnnotationsTests {
    ...
    @Test
    public void
            getInvalidRepeatableAnnotationContainerWithArrayValueAttributeButWrongComponentType() {
    ...
    @Test
    public void
            findInvalidRepeatableAnnotationContainerWithArrayValueAttributeButWrongComponentType() {
        expectContainerWithArrayValueAttributeButWrongComponentType();
        findMergedRepeatableAnnotations(
                getClass(),
                InvalidRepeatable.class,
    ...
    private void expectContainerWithNonArrayValueAttribute() {
        ...
        exception.expectMessage(
                containsString(ContainerWithNonArrayValueAttribute.class.getName()));
        exception.expectMessage(
                containsString("must declare a 'value' attribute for an array of type"));
        exception.expectMessage(containsString(InvalidRepeatable.class.getName()));
    }
