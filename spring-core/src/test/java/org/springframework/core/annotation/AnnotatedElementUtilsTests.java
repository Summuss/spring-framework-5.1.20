...
public class AnnotatedElementUtilsTests {
    ...
    public void getMetaAnnotationTypesOnNonAnnotatedClass() {
        assertTrue(
                getMetaAnnotationTypes(NonAnnotatedClass.class, TransactionalComponent.class)
                        .isEmpty());
        assertTrue(
                getMetaAnnotationTypes(
                                NonAnnotatedClass.class, TransactionalComponent.class.getName())
                        .isEmpty());
    }
    ...
    public void isAnnotatedOnClassWithMetaDepth2() {
        ...
        assertTrue(
                isAnnotated(ComposedTransactionalComponentClass.class, Component.class.getName()));
        assertTrue(
                isAnnotated(
                        ComposedTransactionalComponentClass.class,
                        ComposedTransactionalComponent.class.getName()));
    ...
    @Test
    public void
            getAllAnnotationAttributesOnClassWithLocalComposedAnnotationAndInheritedAnnotation() {
        MultiValueMap<String, Object> attributes =
     ...
     * Such undesirable behavior would cause the logic in {@link
    ...
    public void
        ...
        assertNotNull(
                "Annotation attributes map for @Transactional on DerivedTxConfig", attributes);
        assertEquals(
                "value for DerivedTxConfig.", asList("DerivedTxConfig"), attributes.get("value"));
    }
    ...
    public void
        ...
        assertEquals(
                "value for DerivedTxConfig.", "DerivedTxConfig", attributes.getString("value"));
        // Verify contracts between utility methods:
        assertTrue(isAnnotated(element, name));
    }
    ...
    @Test
    public void
            getMergedAnnotationAttributesFavorsLocalComposedAnnotationOverInheritedAnnotation() {
        Class<?> element = SubClassWithInheritedAnnotation.class;
        String name = TX_NAME;
        AnnotationAttributes attributes = getMergedAnnotationAttributes(element, name);
        assertNotNull(
                "AnnotationAttributes for @Transactional on SubClassWithInheritedAnnotation",
                attributes);
        // Verify contracts between utility methods:
        assertTrue(isAnnotated(element, name));
        assertTrue(
                "readOnly flag for SubClassWithInheritedAnnotation.",
    ...
    public void
        ...
        assertTrue(isAnnotated(element, name));
        assertFalse(
                "readOnly flag for SubSubClassWithInheritedAnnotation.",
                attributes.getBoolean("readOnly"));
    }
    ...
    public void
        ...
        assertTrue(isAnnotated(element, name));
        assertFalse(
                "readOnly flag for SubSubClassWithInheritedComposedAnnotation.",
                attributes.getBoolean("readOnly"));
    }
    ...
    public void getMergedAnnotationAttributesFromInterfaceImplementedBySuperclass() {
        ...
        AnnotationAttributes attributes = getMergedAnnotationAttributes(element, name);
        assertNull(
                "Should not find @Transactional on ConcreteClassWithInheritedAnnotation",
                attributes);
        // Verify contracts between utility methods:
    ...
    public void getMergedAnnotationAttributesWithConventionBasedComposedAnnotation() {
        ...
        assertArrayEquals(
                "locations",
                asArray("explicitDeclaration"),
                attributes.getStringArray("locations"));
        assertArrayEquals(
                "value", asArray("explicitDeclaration"), attributes.getStringArray("value"));
    ...
    public void
        ...
        assertNotNull(
                "Should find @ImplicitAliasesContextConfig on " + element.getSimpleName(),
                attributes);
    ...
    @Test
    public void
            getMergedAnnotationWithImplicitAliasesWithDefaultsInMetaAnnotationOnComposedAnnotation() {
    ...
    public void findMergedAnnotationAttributesOnSubSubInheritedAnnotationInterface() {
        ...
        assertNotNull(
                "Should find @Transactional on SubSubInheritedAnnotationInterface", attributes);
    }
    ...
    @Test
    public void
            findAndSynthesizeAnnotationAttributesOnClassWithAttributeAliasesInTargetAnnotation() {
    ...
    public void findMergedAnnotationWithAttributeAliasesInTargetAnnotation() {
        ...
        assertEquals(
                "TX value via synthesized annotation.", "aliasForQualifier", annotation.value());
        assertEquals(
    ...
    public void javaxMetaAnnotationTypeViaFindMergedAnnotation() throws Exception {
        assertEquals(
                ParametersAreNonnullByDefault.class.getAnnotation(Nonnull.class),
    ...
    public void nullableAnnotationTypeViaFindMergedAnnotation() throws Exception {
        ...
        assertEquals(
                method.getAnnotation(Resource.class), findMergedAnnotation(method, Resource.class));
        assertEquals(
                method.getAnnotation(Resource.class), findMergedAnnotation(method, Resource.class));
    }
