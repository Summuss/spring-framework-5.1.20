...
/**
 * Abstract base class for tests involving concrete implementations of {@link
...
public abstract class AbstractAliasAwareAnnotationAttributeExtractorTestCase {
    ...
    public void getAttributeValueForImplicitAliases() throws Exception {
        assertGetAttributeValueForImplicitAliases(
        ...
        assertGetAttributeValueForImplicitAliases(
                Location2ImplicitAliasesContextConfigClass.class, "location2");
        assertGetAttributeValueForImplicitAliases(
                Location3ImplicitAliasesContextConfigClass.class, "location3");
    }

    private void assertGetAttributeValueForImplicitAliases(Class<?> clazz, String expected)
            throws Exception {
    ...
    protected abstract AnnotationAttributeExtractor<?> createExtractorFor(
