...
public class AnnotationMetadataTests {
    ...
    public void standardAnnotationMetadata() {
        AnnotationMetadata metadata =
                new StandardAnnotationMetadata(AnnotatedComponent.class, true);
    ...
    public void standardAnnotationMetadataForSubclass() {
        AnnotationMetadata metadata =
                new StandardAnnotationMetadata(AnnotatedComponentSubClass.class, true);
    ...
    private void doTestSubClassAnnotationInfo(AnnotationMetadata metadata, boolean asm) {
        ...
        if (asm) {
            ...
            assertThat(
                    ...
                    containsInAnyOrder(NamedComposedAnnotation.class.getName()));
        }
        ...
        assertThat(
                metadata.getAnnotationAttributes(MetaAnnotation.class.getName(), false),
                nullValue());
        assertThat(
                metadata.getAnnotationAttributes(MetaAnnotation.class.getName(), true),
                nullValue());
        assertThat(
                metadata.getAnnotatedMethods(DirectAnnotation.class.getName()).size(), equalTo(0));
        assertThat(metadata.isAnnotated(IsAnnotatedAnnotation.class.getName()), equalTo(false));
        assertThat(
                metadata.getAllAnnotationAttributes(DirectAnnotation.class.getName()), nullValue());
    }

    @Test
    public void standardAnnotationMetadataForInterface() {
        AnnotationMetadata metadata =
                new StandardAnnotationMetadata(AnnotationMetadata.class, true);
    ...
    public void
        ...
        AnnotationMetadata metadata =
                new StandardAnnotationMetadata(NamedComposedAnnotationClass.class);
        assertMultipleAnnotationsWithIdenticalAttributeNames(metadata);
    }
    ...
    private void doTestAnnotationInfo(AnnotationMetadata metadata) {
        ...
        assertEquals(
                "direct",
                method.getAnnotationAttributes(DirectAnnotation.class.getName()).get("value"));
        assertEquals(
                "direct",
                method.getAnnotationAttributes(DirectAnnotation.class.getName()).get("myValue"));
        List<Object> allMeta =
        ...
        allMeta =
                method.getAllAnnotationAttributes(DirectAnnotation.class.getName())
                        .get("additional");
        assertThat(
                new HashSet<>(allMeta), is(equalTo(new HashSet<Object>(Arrays.asList("direct")))));
        ...
        { // perform tests with classValuesAsString = false (the default)
            ...
            assertArrayEquals(
                    new Class<?>[] {String.class}, (Class<?>[]) nestedAnno.get("classArray"));
            ...
            assertArrayEquals(
                    new Class<?>[] {Void.class}, (Class<?>[]) nestedAnnoArray[0].get("classArray"));
            ...
            assertArrayEquals(
                    ...
                    (Class<?>[]) nestedAnnoArray[1].get("classArray"));
            assertArrayEquals(
                    new Class<?>[] {Number.class}, nestedAnnoArray[1].getClassArray("classArray"));
            ...
            assertArrayEquals(
                    new Class<?>[] {Void.class}, (Class<?>[]) optionalArray[0].get("classArray"));
            assertArrayEquals(
                    new Class<?>[] {Void.class}, optionalArray[0].getClassArray("classArray"));
            ...
            assertThat(
                    new HashSet<>(allMeta),
                    is(equalTo(new HashSet<Object>(Arrays.asList("direct", "")))));
            assertEquals(
                    "",
                    metadata.getAnnotationAttributes(DirectAnnotation.class.getName())
                            .get("additional"));
        ...
        { // perform tests with classValuesAsString = true
            ...
            assertArrayEquals(
                    ...
                    (String[]) nestedAnnoArray[0].get("classArray"));
            assertArrayEquals(
                    new String[] {Void.class.getName()},
                    nestedAnnoArray[0].getStringArray("classArray"));
            assertArrayEquals(
                    new String[] {Number.class.getName()},
                    (String[]) nestedAnnoArray[1].get("classArray"));
            assertArrayEquals(
                    new String[] {Number.class.getName()},
                    nestedAnnoArray[1].getStringArray("classArray"));

            AnnotationAttributes optional = specialAttrs.getAnnotation("optional");
            assertArrayEquals(
                    new String[] {Void.class.getName()}, (String[]) optional.get("classArray"));
            assertArrayEquals(
                    new String[] {Void.class.getName()}, optional.getStringArray("classArray"));

            AnnotationAttributes[] optionalArray = specialAttrs.getAnnotationArray("optionalArray");
            assertArrayEquals(
                    new String[] {Void.class.getName()},
                    (String[]) optionalArray[0].get("classArray"));
            assertArrayEquals(
                    new String[] {Void.class.getName()},
                    optionalArray[0].getStringArray("classArray"));
