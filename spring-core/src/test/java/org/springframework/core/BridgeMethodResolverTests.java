...
public class BridgeMethodResolverTests {
    ...
    public void testFindBridgedMethod() throws Exception {
        ...
        assertEquals(
                "Unbridged method not returned directly",
                unbridged,
                BridgeMethodResolver.findBridgedMethod(unbridged));
        assertEquals(
                "Incorrect bridged method returned",
                unbridged,
                BridgeMethodResolver.findBridgedMethod(bridged));
    }
    ...
    public void testIsBridgeMethodFor() throws Exception {
        ...
        assertTrue(
                "Should be bridge method",
                BridgeMethodResolver.isBridgeMethodFor(bridge, bridged, MyBar.class));
        assertFalse(
                "Should not be bridge method",
                BridgeMethodResolver.isBridgeMethodFor(bridge, other, MyBar.class));
    }
    ...
    public void testDoubleParameterization() throws Exception {
        ...
        assertEquals(
                "foo(String) not resolved.",
                stringFoo,
                BridgeMethodResolver.findBridgedMethod(objectBridge));
        assertEquals(
                "foo(Integer) not resolved.",
                integerFoo,
