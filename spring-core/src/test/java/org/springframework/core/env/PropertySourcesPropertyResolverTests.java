...
public class PropertySourcesPropertyResolverTests {
    ...
    public void getProperty_withStringArrayConversion() {
        ...
        assertThat(
                propertyResolver.getProperty("foo", String[].class),
                equalTo(new String[] {"bar", "baz"}));
    }
    ...
    public void getRequiredProperty_withStringArrayConversion() {
        ...
        assertThat(
                propertyResolver.getRequiredProperty("exists", String[].class),
    ...
    public void resolvePlaceholders() {
        ...
        assertThat(
                resolver.resolvePlaceholders("Replace this ${key}"), equalTo("Replace this value"));
    }
    ...
    public void resolvePlaceholders_withUnresolvable() {
        ...
        PropertyResolver resolver = new PropertySourcesPropertyResolver(propertySources);
        assertThat(
                resolver.resolvePlaceholders("Replace this ${key} plus ${unknown}"),
    ...
    public void resolvePlaceholders_withDefaultValue() {
        ...
        PropertyResolver resolver = new PropertySourcesPropertyResolver(propertySources);
        assertThat(
                resolver.resolvePlaceholders("Replace this ${key} plus ${unknown:defaultValue}"),
    ...
    public void resolveRequiredPlaceholders() {
        ...
        PropertyResolver resolver = new PropertySourcesPropertyResolver(propertySources);
        assertThat(
                resolver.resolveRequiredPlaceholders("Replace this ${key}"),
                equalTo("Replace this value"));
    }
