...
public class PersistenceExceptionTranslationInterceptor
     ...
     *
     * <p>Default is to autodetect all PersistenceExceptionTranslators in the containing
    ...
    /**
     * Specify whether to always translate the exception ("true"), or whether throw the raw
     * exception when declared, i.e. when the originating method signature's exception declarations
     * allow for the raw exception to be thrown ("false").
     *
     ...
     * explicitly declare compatible exceptions, the raw exception will be rethrown. If you would
     * like to avoid throwing raw exceptions in any case, switch this flag to "true".
     */
    ...
    public void afterPropertiesSet() {
        if (this.persistenceExceptionTranslator == null && this.beanFactory == null) {
            throw new IllegalArgumentException(
                    "Property 'persistenceExceptionTranslator' is required");
        }
    }
