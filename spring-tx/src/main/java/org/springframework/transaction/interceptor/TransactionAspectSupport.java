 ...
 *
 * <p>If no transaction name has been specified in the {@code TransactionAttribute}, the exposed
 * name will be the {@code fully-qualified class name + "." + method name} (by default).
 *
 * <p>Uses the <b>Strategy</b> design pattern. A {@code PlatformTransactionManager} implementation
 * will perform the actual transaction management, and a {@code TransactionAttributeSource} is used
 * for determining transaction definitions.
 *
