...
public class WebLogicJtaTransactionManager extends JtaTransactionManager {
    ...
    private static final String USER_TRANSACTION_CLASS_NAME =
    ...
    protected UserTransaction retrieveUserTransaction() throws TransactionSystemException {
        ...
        try {
            ...
            throw new TransactionSystemException(
                    "Could not invoke WebLogic's TransactionHelper.getUserTransaction() method",
                    ex);
        }
    }
    ...
    protected TransactionManager retrieveTransactionManager() throws TransactionSystemException {
        ...
        try {
            ...
            Method getTransactionManagerMethod =
                    helper.getClass().getMethod("getTransactionManager");
            ...
            throw new TransactionSystemException(
                    "Could not invoke WebLogic's TransactionHelper.getTransactionManager() method",
                    ex);
        }
    }
        ...
        if (this.weblogicUserTransactionAvailable && definition.getName() != null) {
            try {
                if (timeout > TransactionDefinition.TIMEOUT_DEFAULT) {
                    ...
                    */
                    Assert.state(
                            this.beginWithNameAndTimeoutMethod != null,
                            "WebLogic JTA API not initialized");
                    ...
                    */
                    Assert.state(
                            this.beginWithNameMethod != null, "WebLogic JTA API not initialized");
                    this.beginWithNameMethod.invoke(
                            txObject.getUserTransaction(), definition.getName());
                }
            } catch (InvocationTargetException ex) {
                throw new TransactionSystemException(
        ...
        if (this.weblogicTransactionManagerAvailable) {
            if (definition.getIsolationLevel() != TransactionDefinition.ISOLATION_DEFAULT) {
                try {
                    ...
                    */
                    Assert.state(
                            this.setPropertyMethod != null, "WebLogic JTA API not initialized");
        ...
        try {
            ...
            */
            try {
                ...
                throw new TransactionSystemException(
                        "Could not access WebLogic's TransactionManager.forceResume(Transaction) method",
                        ex2);
            }
        }
    }
