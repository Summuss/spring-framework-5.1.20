...
public class SpringJtaSynchronizationAdapter implements Synchronization {
     ...
     *     an exception thrown in {@code beforeCompletion} (can be omitted if the JTA provider
     *     itself marks the transaction rollback-only in such a scenario, which is required by the
     *     JTA specification as of JTA 1.1).
     */
     ...
     *     case of an exception thrown in {@code beforeCompletion} (can be omitted if the JTA
     *     provider itself marks the transaction rollback-only in such a scenario, which is required
     *     by the JTA specification as of JTA 1.1)
     */
    public SpringJtaSynchronizationAdapter(
            TransactionSynchronization springSynchronization,
     ...
     *
     * <p>Needs to invoke the Spring synchronization's {@code beforeCompletion} at this late stage
     * in case of a rollback, since there is no corresponding callback with JTA.
     *
    ...
    public void afterCompletion(int status) {
        ...
        switch (status) {
            case Status.STATUS_COMMITTED:
                this.springSynchronization.afterCompletion(
