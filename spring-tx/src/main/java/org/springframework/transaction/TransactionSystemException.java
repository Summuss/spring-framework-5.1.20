...
public class TransactionSystemException extends TransactionException {
    ...
    /**
     * Set an application exception that was thrown before this transaction exception, preserving
     * the original exception despite the overriding TransactionSystemException.
     *
