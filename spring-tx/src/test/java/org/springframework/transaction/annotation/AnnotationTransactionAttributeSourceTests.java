...
public class AnnotationTransactionAttributeSourceTests {
    ...
    public void transactionAttributeDeclaredOnClassMethod() throws Exception {
        ...
        assertEquals(
                rbta.getRollbackRules(),
                ((RuleBasedTransactionAttribute) actual).getRollbackRules());
    }
    ...
    public void transactionAttributeOnTargetClassMethodOverridesAttributeOnInterfaceMethod()
        ...
        assertEquals(
                TransactionAttribute.PROPAGATION_REQUIRES_NEW, actual.getPropagationBehavior());
    ...
    public void customClassAttributeWithReadOnlyOverrideOnInterface() throws Exception {
        ...
        assertNotNull(
                "AnnotationUtils.findAnnotation failed to find @Transactional for TestBean9",
                annotation);
    ...
    public void customMethodAttributeWithReadOnlyOverrideOnInterface() throws Exception {
        ...
        assertNull(
                "AnnotationUtils.findAnnotation should not find @Transactional for TestBean10",
                annotation);
    ...
    public void transactionAttributeDeclaredOnClassMethodWithEjb3() throws Exception {
        ...
        assertEquals(
                TransactionAttribute.PROPAGATION_REQUIRED, getAgeAttr.getPropagationBehavior());
        TransactionAttribute getNameAttr =
                atas.getTransactionAttribute(getNameMethod, Ejb3AnnotatedBean1.class);
        assertEquals(
                TransactionAttribute.PROPAGATION_SUPPORTS, getNameAttr.getPropagationBehavior());
    }
    ...
    public void transactionAttributeDeclaredOnGroovyClass() throws Exception {
        ...
        assertEquals(
                TransactionAttribute.PROPAGATION_REQUIRED, getNameAttr.getPropagationBehavior());
