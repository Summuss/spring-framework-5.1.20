...
public class PayloadArgumentResolverTests {
    ...
    public void setup() throws Exception {
        ...
        Method payloadMethod =
                PayloadArgumentResolverTests.class.getDeclaredMethod(
                        "handleMessage",
                        String.class,
                        String.class,
                        Locale.class,
    ...
    public void supportsParameter() throws Exception {
        ...
        PayloadArgumentResolver strictResolver =
                new PayloadArgumentResolver(new StringMessageConverter(), testValidator(), false);
    ...
    public void resolveNotRequired() throws Exception {
        ...
        assertNull(
                this.resolver.resolveArgument(this.paramAnnotatedNotRequired, emptyStringMessage));

        Message<?> notEmptyMessage = MessageBuilder.withPayload("ABC".getBytes()).build();
        assertEquals(
                "ABC",
                this.resolver.resolveArgument(this.paramAnnotatedNotRequired, notEmptyMessage));
    }
