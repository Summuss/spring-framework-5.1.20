...
public class MessageHeaderAccessorTests {
    ...
    public void getAccessor() {
        ...
        assertSame(
                expected, MessageHeaderAccessor.getAccessor(message, MessageHeaderAccessor.class));
    }
    ...
    public void getDetailedLogMessagePayload() {
        ...
        assertEquals(
                expected, accessor.getDetailedLogMessage("p".getBytes(StandardCharsets.UTF_8)));
        assertEquals(
                expected,
