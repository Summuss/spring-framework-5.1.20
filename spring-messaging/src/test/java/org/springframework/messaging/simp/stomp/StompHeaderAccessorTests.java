...
public class StompHeaderAccessorTests {
    ...
    public void toNativeHeadersMessageFrame() {
        ...
        assertEquals(
                "application/json",
                actual.get(StompHeaderAccessor.STOMP_CONTENT_TYPE_HEADER).get(0));
        assertNotNull(
                "message-id was not created",
                actual.get(StompHeaderAccessor.STOMP_MESSAGE_ID_HEADER).get(0));
    }
    ...
    public void toNativeHeadersContentType() {
        ...
        assertEquals(
                ...
                map.get(StompHeaderAccessor.STOMP_CONTENT_TYPE_HEADER).get(0));
    }
    ...
    public void getShortLogMessage() {
        ...
        assertEquals(
                "SEND /foo session=123 application/json payload=" + sb + "...(truncated)", actual);
    }
}
