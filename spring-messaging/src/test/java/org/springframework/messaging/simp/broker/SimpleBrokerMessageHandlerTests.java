...
public class SimpleBrokerMessageHandlerTests {
    ...
    public void subscribeDisconnectPublish() {
        ...
        assertEquals(
                ...
                SimpMessageHeaderAccessor.getMessageType(captured.getHeaders()));
        assertSame(
                message,
                captured.getHeaders().get(SimpMessageHeaderAccessor.DISCONNECT_MESSAGE_HEADER));
    ...
    public void connect() {
        ...
        assertEquals(
                connectMessage,
                connectAckHeaders.getHeader(SimpMessageHeaderAccessor.CONNECT_MESSAGE_HEADER));
    ...
    public void startAndStopWithHeartbeatValue() {
        ...
        when(this.taskScheduler.scheduleWithFixedDelay(any(Runnable.class), eq(15000L)))
                .thenReturn(future);
    ...
    public void readInactivity() throws Exception {
        ...
        assertEquals(
                ...
                headers.get(SimpMessageHeaderAccessor.MESSAGE_TYPE_HEADER));
