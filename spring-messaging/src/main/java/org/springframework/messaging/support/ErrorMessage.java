...
public class ErrorMessage extends GenericMessage<Throwable> {
     ...
     */
    public ErrorMessage(
            Throwable payload, Map<String, Object> headers, Message<?> originalMessage) {
        super(payload, headers);
        this.originalMessage = originalMessage;
    }
    ...
    /**
     * Return the original message (if available) at the point in the stack where the ErrorMessage
     * was created.
     *
     * @since 5.0
     */
