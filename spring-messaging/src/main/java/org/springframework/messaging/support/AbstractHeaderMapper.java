...
public abstract class AbstractHeaderMapper<T> implements HeaderMapper<T> {
     ...
     * header that is being mapped into the protocol-specific Message. The default is an empty
     * String (no prefix).
     */
    ...
    protected String fromHeaderName(String headerName) {
        ...
        if (StringUtils.hasText(this.outboundPrefix)
                && !propertyName.startsWith(this.outboundPrefix)) {
