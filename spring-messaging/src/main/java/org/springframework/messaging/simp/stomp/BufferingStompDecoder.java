...
public class BufferingStompDecoder {
     ...
     *
     * <p>If there was not enough data to parse the "content-length", or if there is
     * "content-length" header, every subsequent call to decode attempts to parse again with all
     * available data. Therefore the presence of a "content-length" header helps to optimize the
     * decoding of large messages.
     *
