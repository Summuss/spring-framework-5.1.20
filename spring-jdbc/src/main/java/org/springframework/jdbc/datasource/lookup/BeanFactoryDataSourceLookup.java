...
public class BeanFactoryDataSourceLookup implements DataSourceLookup, BeanFactoryAware {
     ...
     * container, as the supplied {@link BeanFactory} will be replaced by the {@link BeanFactory}
     * that creates it (c.f. the {@link BeanFactoryAware} contract). So only use this constructor if
     * you are using this class outside the context of a Spring IoC container.
     *
