...
public class EmbeddedDatabaseFactory {
    ...
    /**
     * Factory method that returns the {@linkplain EmbeddedDatabase embedded database} instance,
     * which is also a {@link DataSource}.
     */
     ...
     * auto-generated name.
     *
     * <p>Subclasses may call this method to force initialization; however, this method should only
     * be invoked once.
     *
     * <p>After calling this method, {@link #getDataSource()} returns the {@link DataSource}
        ...
        if (logger.isInfoEnabled()) {
            if (this.dataSource instanceof SimpleDriverDataSource) {
                SimpleDriverDataSource simpleDriverDataSource =
                        (SimpleDriverDataSource) this.dataSource;
                logger.info(
                        String.format(
        ...
        if (this.dataSource != null) {
            if (logger.isInfoEnabled()) {
                if (this.dataSource instanceof SimpleDriverDataSource) {
                    ...
                    logger.info(
                            String.format(
                                    "Shutting down embedded database '%s'", this.databaseName));
                }
            }
            if (this.databaseConfigurer != null) {
    ...
    /**
     * Hook that gets the {@link DataSource} that provides the connectivity to the embedded
     * database.
     *
