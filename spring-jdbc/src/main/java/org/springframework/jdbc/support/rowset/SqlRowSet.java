...
public interface SqlRowSet extends Serializable {
    ...
    /**
     * Retrieve the value of the indicated column in the current row as a String (for NCHAR,
     * NVARCHAR, LONGNVARCHAR columns).
     *
     * @param columnIndex the column index
     ...
     *
     * <p>Note that you must first call one of the getter methods and then call the {@code
     * wasNull()} method.
     *
