 ...
 * {@link SqlXmlValue} instances for marshalling purposes.
 *
 * @author Thomas Risberg
 * @since 2.5.5
 * @see java.sql.ResultSet#getSQLXML
 * @see java.sql.SQLXML
 * @deprecated as of Spring Framework 5.1.5 since this class is only known to be used in
 *     spring-data-jdbc-ext project which was never upgraded to Spring Framework 5.x and is no
...
public interface SqlXmlObjectMappingHandler extends SqlXmlHandler {
    ...
    /**
     * Retrieve the given column as an object marshalled from the XML data retrieved from the given
     * ResultSet.
     *
    ...
    /**
     * Get an instance of an {@code SqlXmlValue} implementation to be used together with the
     * database specific implementation of this {@code SqlXmlObjectMappingHandler}.
     *
