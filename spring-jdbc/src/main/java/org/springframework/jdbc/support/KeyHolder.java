...
public interface KeyHolder {
     ...
     * map, and that the item is a number. This is the typical case: a single, numeric generated
     * key.
     *
     ...
     *
     * <p>Can be used for extracting keys for multiple rows (an unusual case), and also for adding
     * new maps of keys.
     *
     * @return the List for the generated keys, with each entry representing an individual row
     *     through a Map of column names and key values
     */
