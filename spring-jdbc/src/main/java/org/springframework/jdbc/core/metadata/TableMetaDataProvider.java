...
public interface TableMetaDataProvider {
     ...
     * initialization can be turned off by specifying that column meta-data should not be used.
     *
     * @param databaseMetaData used to retrieve database specific information
    ...
    /**
     * Get the catalog name formatted based on meta-data information. This could include altering
     * the case.
     */
    @Nullable
