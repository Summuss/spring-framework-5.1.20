...
public interface SimpleJdbcCallOperations {
     ...
     * class which - for backwards compatibility reasons - allows input values to be provided for
     * parameters declared as {@code SqlOutParameter}.
     *
     ...
     * by a {@link RowMapper}. The results will be returned using the parameter name specified.
     * Multiple ResultSets must be declared in the correct order.
     *
     ...
     *     Parameter values must be provided in the same order as the parameters are defined for the
     *     stored procedure.
     */
    ...
    /**
     * Execute the stored procedure and return the single out parameter as an Object of the
     * specified return type. In the case where there are multiple out parameters, the first one is
     * returned and additional out parameters are ignored.
     *
     * @param returnType the type of the value to return
     * @param args optional array containing the in parameter values to be used in the call.
     *     Parameter values must be provided in the same order as the parameters are defined for the
