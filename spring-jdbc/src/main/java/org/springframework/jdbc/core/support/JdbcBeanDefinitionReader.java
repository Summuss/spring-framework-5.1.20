...
public class JdbcBeanDefinitionReader {
     ...
     *     possible to perform a join. Column names are not significant -- only the ordering of
     *     these first three columns.
     */
    public void loadBeanDefinitions(String sql) {
        Assert.notNull(
                this.jdbcTemplate, "Not fully configured - specify DataSource or JdbcTemplate");
