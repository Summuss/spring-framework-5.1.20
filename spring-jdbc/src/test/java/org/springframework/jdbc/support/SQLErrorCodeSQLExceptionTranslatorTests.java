...
public class SQLErrorCodeSQLExceptionTranslatorTests {
    ...
    public void errorCodeTranslation() {
        ...
        assertTrue(
                "Not instance of DataIntegrityViolationException",
    ...
    public void customExceptionTranslation() {
        ...
        SQLException badSqlEx = new SQLException("", "", 1);
        assertEquals(
                CustomErrorCodeException.class, sext.translate(TASK, SQL, badSqlEx).getClass());
    ...
    public void dataSourceInitialization() throws Exception {
        ...
        assertFalse(
                sext.translate("test", null, duplicateKeyException)
