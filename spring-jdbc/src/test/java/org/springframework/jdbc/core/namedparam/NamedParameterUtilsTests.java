...
public class NamedParameterUtilsTests {
    ...
    public void parseSql() {
        ...
        assertEquals(
                "xxx ? yyyy ? ? ? zzzzz",
                NamedParameterUtils.substituteNamedParameters(psql, null));
        ...
        assertEquals(
                "xxx ? yyyy ? zzzzz", NamedParameterUtils.substituteNamedParameters(psql2, null));
    ...
    public void substituteNamedParameters() {
        ...
        assertEquals(
                "xxx ? ? ?",
                NamedParameterUtils.substituteNamedParameters("xxx :a :b :c", namedParams));
        assertEquals(
                "xxx ? ? ? xx ? ?",
    ...
    public void convertParamMapToArray() {
        ...
        assertSame(
                5, NamedParameterUtils.buildValueArray("xxx :a :b :c xx :a :b", paramMap).length);
        assertSame(
                5, NamedParameterUtils.buildValueArray("xxx :a :a :a xx :a :a", paramMap).length);
        assertEquals(
                "b", NamedParameterUtils.buildValueArray("xxx :a :b :c xx :a :b", paramMap)[4]);
        try {
    ...
    public void convertTypeMapToArray() {
        ...
        assertSame(
                5,
                NamedParameterUtils.buildSqlTypeArray(
                                NamedParameterUtils.parseSqlStatement("xxx :a :a :a xx :a :a"),
                                namedParams)
                        .length);
        assertEquals(
                2,
