...
public class AspectJPrecedenceComparatorTests {
    ...
    public void testSameAspectNoAfterAdvice() {
        ...
        assertEquals(
                "advisor1 sorted before advisor2", -1, this.comparator.compare(advisor1, advisor2));
        ...
        advisor2 =
                createAspectJAroundAdvice(
                        ...
                        "someAspect");
        assertEquals(
                "advisor2 sorted before advisor1", 1, this.comparator.compare(advisor1, advisor2));
    }
    ...
    public void testSameAspectOneOfEach() {
        ...
        Advisor advisor2 =
                createAspectJBeforeAdvice(
                        HIGH_PRECEDENCE_ADVISOR_ORDER, LATE_ADVICE_DECLARATION_ORDER, "someAspect");
        assertEquals(
                "advisor1 and advisor2 not comparable",
                1,
                this.comparator.compare(advisor1, advisor2));
    }
    ...
    public void testSameAdvisorPrecedenceDifferentAspectNoAfterAdvice() {
        ...
        Advisor advisor2 =
                createAspectJBeforeAdvice(
                        ...
                        "someOtherAspect");
        assertEquals(
                "nothing to say about order here", 0, this.comparator.compare(advisor1, advisor2));
    ...
    public void testHigherAdvisorPrecedenceAfterAdvice() {
        ...
        advisor2 =
                createAspectJAfterThrowingAdvice(
                        ...
                        "someOtherAspect");
        assertEquals(
                "advisor2 sorted after advisor1", -1, this.comparator.compare(advisor1, advisor2));
    }
    ...
    public void testLowerAdvisorPrecedenceNoAfterAdvice() {
        ...
        Advisor advisor2 =
                createAspectJBeforeAdvice(
                        ...
                        "someOtherAspect");
        assertEquals(
                "advisor1 sorted after advisor2", 1, this.comparator.compare(advisor1, advisor2));
