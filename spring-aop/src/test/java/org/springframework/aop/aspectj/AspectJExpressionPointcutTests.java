...
public class AspectJExpressionPointcutTests {
    ...
    public void testMatchExplicit() {
        String expression =
                "execution(int org.springframework.tests.sample.beans.TestBean.getAge())";
        ...
        assertFalse(
                "Expression should match setAge() method",
                methodMatcher.matches(setAge, TestBean.class));
    }
    ...
    public void testMatchWithTypePattern() throws Exception {
        ...
        assertMatchesGetAge(methodMatcher);
        assertTrue(
                "Expression should match setAge(int) method",
                methodMatcher.matches(setAge, TestBean.class));
    }
    ...
    private void testThisOrTarget(String which) throws SecurityException, NoSuchMethodException {
        ...
        assertTrue(
                iOtherPc.matches(OtherIOther.class.getMethod("absquatulate"), OtherIOther.class));
        assertFalse(
                testBeanPc.matches(OtherIOther.class.getMethod("absquatulate"), OtherIOther.class));
    }
    ...
    public void testMatchWithArgs() throws Exception {
        ...
        assertTrue(
                "Should match with setSomeNumber with Double input",
                methodMatcher.matches(setSomeNumber, TestBean.class, new Double(12)));
        assertFalse(
                "Should not match setSomeNumber with Integer input",
    ...
    private void assertMatchesGetAge(MethodMatcher methodMatcher) {
        assertTrue(
                "Expression should match getAge() method",
                methodMatcher.matches(getAge, TestBean.class));
    }
    ...
    public void testWithUnsupportedPointcutPrimitive() {
        ...
        try {
            ...
            assertEquals(
                    "Should not support call pointcut",
                    PointcutPrimitive.CALL,
                    ex.getUnsupportedPrimitive());
        }
    }
    ...
    public void testMultipleAndSubstitutions() {
        ...
        PointcutExpression expr = ((AspectJExpressionPointcut) pc).getPointcutExpression();
        assertEquals(
                "execution(* *(..)) && args(String) && this(Object)", expr.getPointcutExpression());
    }
