...
public class AspectJAdviceParameterNameDiscovererTests {
    ...
    protected void assertException(
            Method method, String pointcut, Class<?> exceptionType, String message) {
    ...
    protected void assertException(
        ...
        try {
            ...
            assertEquals(
                    "Expecting exception of type " + exceptionType.getName(),
                    exceptionType,
                    expected.getClass());
            assertEquals(
                    "Exception message does not match expected", message, expected.getMessage());
        }
    }
