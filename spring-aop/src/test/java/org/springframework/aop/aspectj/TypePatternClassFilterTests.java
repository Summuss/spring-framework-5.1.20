...
public class TypePatternClassFilterTests {
    ...
    public void testValidPatternMatching() {
        ...
        assertFalse(
                "Must be excluded: in wrong package",
    ...
    public void testSubclassMatching() {
        ...
        assertFalse(
                "Must be excluded: not subclass", tpcf.matches(DefaultListableBeanFactory.class));
    }
    ...
    public void testToString() {
        ...
        assertEquals(
                "org.springframework.aop.aspectj.TypePatternClassFilter: org.springframework.tests.sample.beans.*",
                filter1.toString());
