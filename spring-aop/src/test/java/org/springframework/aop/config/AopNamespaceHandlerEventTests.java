...
public class AopNamespaceHandlerEventTests {
    ...
    public void testPointcutEvents() {
        ...
        assertTrue(
                "No holder with nested components",
                componentDefinitions[0] instanceof CompositeComponentDefinition);
    ...
    public void testAdvisorEventsWithPointcutRef() {
        ...
        assertTrue(
                "No advice bean found", componentDefinitions[1] instanceof BeanComponentDefinition);
