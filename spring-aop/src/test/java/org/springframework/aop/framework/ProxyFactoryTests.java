...
public class ProxyFactoryTests {
    ...
    public void testReplaceAdvisor() {
        ...
        assertEquals(1, nop.getCount());
        assertFalse(
                advised.replaceAdvisor(new DefaultPointcutAdvisor(new NopInterceptor()), advisor2));
    ...
    public void testGetsAllInterfaces() throws Exception {
        ...
        assertEquals(
                "Found correct number of interfaces", 5, factory.getProxiedInterfaces().length);
        ...
        assertEquals(
                "Advisor proxies one more interface after introduction",
                oldProxiedInterfaces.length + 1,
                newProxiedInterfaces.length);
    ...
    public void testCanAddAndRemoveAspectInterfacesOnSingleton() {
        ...
        assertFalse(
                "Should no longer implement TimeStamped", config.getProxy() instanceof TimeStamped);
