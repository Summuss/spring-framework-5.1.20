...
public class ComposablePointcutTests {
    ...
    public void testMatchAll() throws NoSuchMethodException {
        ...
        assertTrue(
                pc.getMethodMatcher().matches(Object.class.getMethod("hashCode"), Exception.class));
    }
    ...
    public void testIntersectionMethodMatcher() {
        ...
        assertTrue(
                pc.getMethodMatcher().matches(PointcutsTests.TEST_BEAN_GET_NAME, TestBean.class));
