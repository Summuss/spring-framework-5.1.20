...
public class PointcutsTests {
    ...
    public void testTrue() {
        assertTrue(
                Pointcuts.matches(
                        Pointcut.TRUE, TEST_BEAN_SET_AGE, TestBean.class, new Integer(6)));
    ...
    public void testMatches() {
        ...
        assertFalse(
                Pointcuts.matches(allClassSetterPointcut, TEST_BEAN_ABSQUATULATE, TestBean.class));
        assertFalse(
                Pointcuts.matches(
        ...
        assertFalse(
                Pointcuts.matches(allClassGetterPointcut, TEST_BEAN_ABSQUATULATE, TestBean.class));
    }
    ...
    public void testIntersectionOfSpecificGettersAndSubclassGetters() {
        ...
        assertFalse(
                Pointcuts.matches(myTestBeanGetterPointcut, TEST_BEAN_GET_NAME, TestBean.class));
        assertFalse(Pointcuts.matches(myTestBeanGetterPointcut, TEST_BEAN_GET_AGE, TestBean.class));
        assertTrue(
                Pointcuts.matches(myTestBeanGetterPointcut, TEST_BEAN_GET_NAME, MyTestBean.class));
        assertTrue(
                Pointcuts.matches(myTestBeanGetterPointcut, TEST_BEAN_GET_AGE, MyTestBean.class));
    ...
    public void testSimpleIntersection() {
        ...
        assertFalse(
                Pointcuts.matches(intersection, TEST_BEAN_SET_AGE, TestBean.class, new Integer(6)));
        assertFalse(Pointcuts.matches(intersection, TEST_BEAN_GET_AGE, TestBean.class));
