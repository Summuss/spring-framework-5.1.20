 ...
 *
 * <p>These methods are particularly useful for composing pointcuts using the union and intersection
 * methods.
 *
 * @author Rod Johnson
...
public abstract class Pointcuts {
     ...
     * @return a distinct Pointcut that matches all methods that either of the given Pointcuts
     *     matches
     */
    ...
    private static class SetterPointcut extends StaticMethodMatcherPointcut
    ...
    @SuppressWarnings("serial")
    private static class GetterPointcut extends StaticMethodMatcherPointcut
            implements Serializable {
