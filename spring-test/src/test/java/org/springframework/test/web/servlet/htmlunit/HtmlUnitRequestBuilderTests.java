...
public class HtmlUnitRequestBuilderTests {
    ...
    public void buildRequestLocaleMulti() {
        ...
        List<Locale> expected =
                asList(new Locale("da"), new Locale("en", "gb"), new Locale("en", ""));
    ...
    public void mergeHeader() throws Exception {
        ...
        assertThat(
                mockMvc.perform(requestBuilder).andReturn().getRequest().getHeader(headerName),
                equalTo(headerValue));
    }
    ...
    public void mergeSessionNotInitialized() throws Exception {
        ...
        assertThat(
                mockMvc.perform(requestBuilder).andReturn().getRequest().getSession(false),
                nullValue());
    }
    ...
    public void mergeParameter() throws Exception {
        ...
        assertThat(
                asList(performedRequest.getParameterValues(paramName)),
                contains(paramValue, paramValue2));
    }
    ...
    public void mergeRequestAttribute() throws Exception {
        ...
        assertThat(
                mockMvc.perform(requestBuilder).andReturn().getRequest().getAttribute(attrName),
                equalTo(attrValue));
    }
    ...
    public void mergeDoesNotCorruptPathInfoOnParent() throws Exception {
        ...
        assertThat(
                mockMvc.perform(get(pathInfo)).andReturn().getRequest().getPathInfo(),
                equalTo(pathInfo));
