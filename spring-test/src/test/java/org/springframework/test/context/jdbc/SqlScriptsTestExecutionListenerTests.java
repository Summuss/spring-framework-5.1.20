...
public class SqlScriptsTestExecutionListenerTests {
    ...
    public void valueAndScriptsDeclared() throws Exception {
        ...
        exception.expectMessage(
                either(containsString("attribute 'value' and its alias 'scripts'"))
                        .or(containsString("attribute 'scripts' and its alias 'value'")));
        exception.expectMessage(
                either(containsString("values of [{foo}] and [{bar}]"))
                        .or(containsString("values of [{bar}] and [{foo}]")));
