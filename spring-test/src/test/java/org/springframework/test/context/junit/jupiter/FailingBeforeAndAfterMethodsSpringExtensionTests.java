...
class FailingBeforeAndAfterMethodsSpringExtensionTests {
        ...
        return testClasses()
                .map(
                        clazz ->
                                dynamicTest(
                                        clazz.getSimpleName(),
                                        () -> runTestAndAssertCounters(clazz)));
    }
    ...
    private void runTestAndAssertCounters(Class<?> testClass) {
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                0, summary.getTestsSkippedCount(), () -> name + ": tests skipped"),
                () ->
                        assertEquals(
                                0, summary.getTestsAbortedCount(), () -> name + ": tests aborted"),
                () ->
                        assertEquals(
