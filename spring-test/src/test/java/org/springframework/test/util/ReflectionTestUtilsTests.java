...
public class ReflectionTestUtilsTests {
    ...
    public void getStaticFieldViaClass() throws Exception {
        ...
        assertEquals(
                "private static field", "private", getField(StaticFields.class, "privateField"));
    }
    ...
    public void invokeSetterMethodAndInvokeGetterMethodWithExplicitMethodNames() throws Exception {
        ...
        assertEquals(
                "'likes pets' flag (protected method for a boolean)", false, person.likesPets());
        assertEquals(
                "'favorite number' (protected method for a Number)",
                Integer.valueOf(42),
    ...
    @Test
    public void invokeSetterMethodAndInvokeGetterMethodWithJavaBeanPropertyNames()
            throws Exception {
        ...
        assertEquals(
                "'likes pets' flag (protected method for a boolean)", true, person.likesPets());
        assertEquals(
                "'favorite number' (protected method for a Number)",
                PI,
                person.getFavoriteNumber());
    ...
    public void invokeMethodSimulatingLifecycleEvents() {
        ...
        assertEquals(
                "number should have been configured", Integer.valueOf(42), component.getNumber());
