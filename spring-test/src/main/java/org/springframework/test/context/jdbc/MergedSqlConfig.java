...
class MergedSqlConfig {
    ...
    MergedSqlConfig(SqlConfig localSqlConfig, Class<?> testClass) {
        ...
        this.separator =
                getString(attributes, "separator", ScriptUtils.DEFAULT_STATEMENT_SEPARATOR);
        this.commentPrefix =
                getString(attributes, "commentPrefix", ScriptUtils.DEFAULT_COMMENT_PREFIX);
        ...
        this.errorMode =
                getEnum(attributes, "errorMode", ErrorMode.DEFAULT, ErrorMode.FAIL_ON_ERROR);
    }
