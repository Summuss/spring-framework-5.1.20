...
public abstract class TestContextResourceUtils {
     ...
     *       for example: {@code "/org/example/schema.sql"}.
     *   <li>A path which is prefixed with a URL protocol (e.g., {@link
     *       ResourceUtils#CLASSPATH_URL_PREFIX classpath:}, {@link ResourceUtils#FILE_URL_PREFIX
     *       file:}, {@code http:}, etc.) will be {@link StringUtils#cleanPath cleaned} but
