...
/**
 * Utility methods for {@link SmartContextLoader SmartContextLoaders} that deal with component
...
public abstract class AnnotationConfigContextLoaderUtils {
     ...
     * org.springframework.test.context.SmartContextLoader SmartContextLoader} SPI. Specifically,
     * this method uses introspection to detect default configuration classes that comply with the
     * constraints required of {@code @Configuration} class implementations. If a potential
     * candidate configuration class does not meet these requirements, this method will log a debug
     * message, and the potential candidate class will be ignored.
     *
