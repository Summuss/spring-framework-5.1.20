...
/**
 * {@code TestPropertySourceAttributes} encapsulates the attributes declared via {@link
 ...
 * enforces configuration rules and detects default properties files.
 *
 * @author Sam Brannen
 * @since 4.1
...
class TestPropertySourceAttributes {
    ...
    /**
     * Create a new {@code TestPropertySourceAttributes} instance for the supplied {@link
     * TestPropertySource @TestPropertySource} annotation and the {@linkplain Class test class} that
     * declared it, enforcing configuration rules and detecting a default properties file if
     * necessary.
     *
    ...
    private TestPropertySourceAttributes(
     ...
     *
     * <p>Note: The returned value may represent a <em>detected default</em> that does not match the
     * original value declared via {@code @TestPropertySource}.
     *
    ...
    /**
     * Detect a default properties file for the supplied class, as specified in the class-level
     * Javadoc for {@link TestPropertySource}.
     */
    private static String detectDefaultPropertiesFile(Class<?> testClass) {
        ...
        if (classPathResource.exists()) {
            ...
            String msg =
                    String.format(
                            "Could not detect default properties file for test [%s]: "
