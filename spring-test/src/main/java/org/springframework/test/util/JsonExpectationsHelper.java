...
public class JsonExpectationsHelper {
     ...
     * they contain different attribute-value pairs regardless of formatting with a lenient checking
     * (extensible, and non-strict array ordering).
     *
     * @param expected the expected JSON content
     * @param actual the actual JSON content
    ...
    /**
     * Parse the expected and actual strings as JSON and assert the two are "not similar" - i.e.
     * they contain different attribute-value pairs regardless of formatting.
     *
     * <p>Can compare in two modes, depending on {@code strict} parameter value:
     *
     * <ul>
     ...
     * @since 4.2
     */
    public void assertJsonNotEqual(String expected, String actual, boolean strict)
            throws Exception {
