...
public class ModelResultMatchers {
    ...
    public ResultMatcher attributeExists(final String... names) {
        return result -> {
            ...
            for (String name : names) {
                assertTrue(
                        "Model attribute '" + name + "' does not exist",
    ...
    public ResultMatcher attributeDoesNotExist(final String... names) {
        return result -> {
            ...
            for (String name : names) {
                assertTrue(
                        "Model attribute '" + name + "' exists", mav.getModel().get(name) == null);
            }
        };
    }
    ...
    public ResultMatcher attributeHasFieldErrorCode(
            final String name, final String fieldName, final String error) {
        return mvcResult -> {
            ModelAndView mav = getModelAndView(mvcResult);
            BindingResult result = getBindingResult(mav, name);
            assertTrue("No errors for attribute '" + name + "'", result.hasErrors());
            ...
            assertTrue(
                    "Expected error code '" + error + "' but got '" + code + "'",
                    error.equals(code));
        };
    }
    ...
    public <T> ResultMatcher attributeHasFieldErrorCode(
            final String name, final String fieldName, final Matcher<? super String> matcher) {
