...
public abstract class MockMvcResultMatchers {
    ...
    public static ResultMatcher forwardedUrlPattern(String urlPattern) {
        return result -> {
            ...
            assertTrue(
                    "Forwarded URL does not match the expected URL pattern",
    ...
    public static ResultMatcher redirectedUrlPattern(String urlPattern) {
        return result -> {
            ...
            assertTrue(
                    "Redirected URL does not match the expected URL pattern",
                    (url != null && pathMatcher.match(urlPattern, url)));
        };
    }
     ...
     * Access to response body assertions using a <a
     * href="https://github.com/jayway/JsonPath">JsonPath</a> expression to inspect a specific
     * subset of the body and a Hamcrest matcher for asserting the value found at the JSON path.
     *
